...
deploy/kuma/minikube: ## Minikube: Deploy Kuma with no demo app
	...
	kubectl wait --timeout=120s --for=condition=Available -n kuma-system deployment/kuma-control-plane
	kubectl wait --timeout=120s --for=condition=Ready -n kuma-system pods -l app=kuma-control-plane
