...
build/artifacts-$(1)-$(2)/envoy:
	mkdir -p $$(@) && \
	[ -f $$(@)/envoy ] || \
	curl -s --fail --location https://github.com/lobkovilya/envoy-builds/releases/download/v$(ENVOY_VERSION)-no-symbols/envoy-$(1)-$(2)-v$(ENVOY_VERSION)$(ENVOY_EXT_$(1)_$(2)).tar.gz | tar -C $$(@) -xz
