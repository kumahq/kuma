...
image/static/$(1): ## Dev: Rebuild `kuma-static` Docker image
	$(DOCKER_BUILD) $(DOCKER_BUILD_OPTS) $(call DOCKER_BUILDX_OPTS,static-debian11,$(1)) -t kumahq/static-debian11:no-push-$(1) --build-arg ARCH=$(1) --platform=linux/$(1) -f $(TOOLS_DIR)/releases/dockerfiles/static.Dockerfile .

.PHONY: image/base/$(1)
image/base/$(1): ## Dev: Rebuild `kuma-base` Docker image
	$(DOCKER_BUILD) $(DOCKER_BUILD_OPTS) $(call DOCKER_BUILDX_OPTS,base-nossl-debian11,$(1)) -t kumahq/base-nossl-debian11:no-push-$(1) --build-arg ARCH=$(1) --platform=linux/$(1) -f $(TOOLS_DIR)/releases/dockerfiles/base.Dockerfile .

.PHONY: image/base-root/$(1)
image/base-root/$(1): ## Dev: Rebuild `kuma-base-root` Docker image
	$(DOCKER_BUILD) $(DOCKER_BUILD_OPTS) $(call DOCKER_BUILDX_OPTS,base-root-debian11,$(1)) -t kumahq/base-root-debian11:no-push-$(1) --build-arg ARCH=$(1) --platform=linux/$(1) -f $(TOOLS_DIR)/releases/dockerfiles/base-root.Dockerfile .
