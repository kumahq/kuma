...
GINKGO_TEST=$(GINKGO) $(GOFLAGS) ENVOY_VERSION_$(GOOS)_$(GOARCH)=$(ENVOY_VERSION) $(call LD_FLAGS,$(GOOS),$(GOARCH)) --keep-going --keep-separate-reports --junit-report results.xml --output-dir $(REPORTS_DIR) $(GINKGO_OPTS)
