...
ifdef CI
	GINKO_TEST_PARALLELIZM := --procs 2
else
	GINKO_TEST_PARALLELIZM := -p
endif
...
GINKGO_TEST:=$(GINKGO) $(GOFLAGS) $(LD_FLAGS) $(GINKO_TEST_PARALLELIZM) --keep-going --keep-separate-reports --junit-report results.xml --output-dir $(REPORTS_DIR)
