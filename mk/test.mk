...
UNIT_LD_FLAGS ?= -ldflags="-X github.com/kumahq/kuma/v2/pkg/version.version=0.0.0 -X github.com/kumahq/kuma/v2/pkg/version.gitTag=0000000 -X github.com/kumahq/kuma/v2/pkg/version.gitCommit=0000000 -X github.com/kumahq/kuma/v2/pkg/version.buildDate=local-build -X github.com/kumahq/kuma/v2/pkg/version.Envoy=$(ENVOY_VERSION)"
