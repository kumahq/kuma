...
.PHONY: kind/load/external-dependencies
kind/load/external-dependencies:
	docker pull mendhak/http-https-echo
	@kind load docker-image mendhak/http-https-echo --name=$(KIND_CLUSTER_NAME)

.PHONY: kind/load/images
kind/load/images: kind/load/control-plane kind/load/kuma-dp kind/load/kuma-init kind/load/kuma-prometheus-sd kind/load/kumactl kind/load/kuma-universal kind/load/external-dependencies
