...
# --- API server and controller-manager throughput ---
# Raise default in-flight request limits and concurrent reconciler counts to
# reduce queuing under the load generated by multizone E2E tests (many pods,
# policies, and KDS syncs hitting the API server simultaneously).
# k3s defaults: max-requests-inflight=400, max-mutating-requests-inflight=200
# (already generous, but explicit for clarity and to survive k3s default changes).
K3D_CLUSTER_CREATE_OPTS += \
