...
# --- Controller-manager throughput ---
# Raise concurrent reconciler counts to reduce queuing under the load generated
# by multizone E2E tests (many pods, policies, and KDS syncs hitting the API
# server simultaneously).
# Note: kube-apiserver max-requests-inflight / max-mutating-requests-inflight
# were removed in k8s 1.30 (replaced by API Priority and Fairness).
K3D_CLUSTER_CREATE_OPTS += \
