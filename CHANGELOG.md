...
* fix(gui): api base path fix [#5341](https://github.com/kumahq/kuma/pull/5341) @kleinfreund
* fix(ebpf): include ebpf programs in artifacts [#5262](https://github.com/kumahq/kuma/pull/5262) @bartsmykla
