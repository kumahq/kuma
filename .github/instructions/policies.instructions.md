...
- `MatchedPolicies()` - generated by `make generate` into `zz_generated.matcher.go`; never hand-write it
...
### Plugin
- MatchedPolicies is generated (`zz_generated.matcher.go`), not hand-written
...
// MatchedPolicies is generated by policy-gen into zz_generated.matcher.go; do not hand-write it.
