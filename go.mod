...
require (
	...
	github.com/envoyproxy/data-plane-api v0.0.0-20220321191708-ee2b18aee136 // indirect
	...
	github.com/googleapis/googleapis v0.0.0-20220324002754-abfc24ebf262 // indirect
