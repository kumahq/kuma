...
require (
	...
	github.com/envoyproxy/data-plane-api v0.0.0-20220208141349-e0814b240812 // indirect
	...
	github.com/googleapis/googleapis v0.0.0-20220217011826-f30b83dd43b3 // indirect
