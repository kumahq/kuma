...
require (
	...
	github.com/envoyproxy/data-plane-api v0.0.0-20220405154757-4d66fafcf244 // indirect
	...
	github.com/googleapis/googleapis v0.0.0-20220405213346-fb51f3cd6019 // indirect
