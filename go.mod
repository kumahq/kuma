...
require (
	...
	github.com/envoyproxy/data-plane-api v0.0.0-20220219041452-c0da0e3e8bae // indirect
	...
	github.com/googleapis/googleapis v0.0.0-20220220003007-60526031e76f // indirect
