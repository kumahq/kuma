...
| controlPlane.tls.kdsZoneClient.clientCertSecretName | string | `""` | Name of the K8s Secret resource that contains tls.crt and tls.key of the client certificate presented to KDS Global Server. |
