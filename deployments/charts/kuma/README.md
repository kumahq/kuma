...
| dataPlane.initContainer | object | `{"resources":{"limits":{"cpu":"0","memory":"50Mi"},"requests":{"cpu":"20m","memory":"20Mi"}}}` | Resource limits and requests for the kuma-init container. Set cpu limit to "0" to disable the CPU limit (default). |
