...
func (in *Verification) DeepCopyInto(out *Verification) {
	*out = *in
	...
	if in.CaCert != nil {
		...
		*out = new(VerificationDataSource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerificationDataSource) DeepCopyInto(out *VerificationDataSource) {
	*out = *in
	if in.Secret != nil {
	...
	if in.SecretRef != nil {
		...
		*out = new(datasource.SecretRef)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerificationDataSource.
func (in *VerificationDataSource) DeepCopy() *VerificationDataSource {
	if in == nil {
		return nil
	}
	out := new(VerificationDataSource)
