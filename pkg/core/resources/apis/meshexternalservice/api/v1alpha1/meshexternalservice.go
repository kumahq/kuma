...
type Verification struct {
	...
	CaCert *datasource_api.SecureDataSource `json:"caCert,omitempty"`
	// ClientCert defines a certificate of a client.
	ClientCert *datasource_api.SecureDataSource `json:"clientCert,omitempty"`
	// ClientKey defines a client private key.
	ClientKey *datasource_api.SecureDataSource `json:"clientKey,omitempty"`
}
