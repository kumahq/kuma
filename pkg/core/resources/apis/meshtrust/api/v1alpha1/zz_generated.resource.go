...
func init() {
	...
	if rawOpenAPISpec != nil {
		...
		// Extract schema from .components.schemas.MeshTrustItem
		...
		schemaItem, ok := schemas["MeshTrustItem"].(map[string]interface{})
		if !ok {
			panic(fmt.Errorf("MeshTrustItem schema not found"))
		}
