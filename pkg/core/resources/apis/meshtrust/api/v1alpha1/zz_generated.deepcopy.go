...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshTrustStatus) DeepCopyInto(out *MeshTrustStatus) {
	*out = *in
	if in.Origin != nil {
		in, out := &in.Origin, &out.Origin
		*out = new(Origin)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshTrustStatus.
func (in *MeshTrustStatus) DeepCopy() *MeshTrustStatus {
	if in == nil {
		return nil
	}
	out := new(MeshTrustStatus)
	in.DeepCopyInto(out)
	return out
}
