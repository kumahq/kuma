...
func init() {
	...
	if rawOpenAPISpec != nil {
		...
		// Extract schema from .components.schemas.MeshMultiZoneServiceItem
		...
		schemaItem, ok := schemas["MeshMultiZoneServiceItem"].(map[string]interface{})
		if !ok {
			panic(fmt.Errorf("MeshMultiZoneServiceItem schema not found"))
		}
