...
import (
	hostnamegeneratorapiv1alpha1 "github.com/kumahq/kuma/pkg/core/resources/apis/hostnamegenerator/api/v1alpha1"
...
func (in *MeshMultiZoneServiceStatus) DeepCopyInto(out *MeshMultiZoneServiceStatus) {
	*out = *in
	if in.Ports != nil {
		...
		*out = make([]apiv1alpha1.Port, len(*in))
		copy(*out, *in)
	}
	if in.Addresses != nil {
		in, out := &in.Addresses, &out.Addresses
		*out = make([]hostnamegeneratorapiv1alpha1.Address, len(*in))
		copy(*out, *in)
	}
	if in.VIPs != nil {
		in, out := &in.VIPs, &out.VIPs
		*out = make([]apiv1alpha1.VIP, len(*in))
		copy(*out, *in)
	}
