...
// The autogenerated CA is RSA-2048. A user provided CA can use any key type the
// workload certificate generation supports, see generateKey.
func GenerateRootCA(trustDomain string) (*util_tls.KeyPair, error) {
