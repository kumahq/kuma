...
var _ = Describe("Updater", func() {
	...
	It("should keep the pinned trust domain when the zone is renamed", func() {
		// the identity was pinned while the zone was still called "default", which is
		// what a standalone zone looks like right before it is federated. Re-rendering
		// it would move issuance into a domain no MeshTrust publishes yet
		Expect(
			samples.MeshDefaultBuilder().
				Create(resManager),
		).To(Succeed())
