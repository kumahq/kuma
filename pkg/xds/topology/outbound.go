...
func BuildDataplaneZoneIngressEndpointMap(
	...
	fillLocalMeshServices(outbound, meshServices, dataplanes, mesh, localZone, inboundTagsDisabled)
...
func BuildIngressEndpointMap(
	...
	outbound := BuildEdsEndpointMap(ctx, mesh, localZone, meshServices, meshMultiZoneServices, meshExternalServices, dataplanes, nil, nil, zoneEgresses, externalServices, loader, mtlsEnabled, egressAddresses, inboundTagsDisabled)
	return outbound
}
...
func BuildEdsEndpointMap(
	...
	fillDataplaneOutbounds(outbound, dataplanes, mesh, endpointWeight, localZone, meshServiceDestinations, inboundTagsDisabled)
