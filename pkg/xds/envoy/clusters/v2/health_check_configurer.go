...
<<<<<<< HEAD:pkg/xds/envoy/clusters/health_check_configurer.go
...
>>>>>>> 9df49a19... chore(kuma-cp) generate V3 clusters and endpoints (#1312):pkg/xds/envoy/clusters/v2/health_check_configurer.go
