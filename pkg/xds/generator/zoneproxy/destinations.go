...
func BuildMeshDestinations(
	...
	addMeshHTTPRouteDestinations(res.TrafficRoutes().Items, meshHTTPRoutes, destForMesh)
	addMeshTCPRouteDestinations(res.TrafficRoutes().Items, meshTCPRoutes, destForMesh)
