...
type IdentityProvider interface {
	Get(context.Context, Identity, *core_mesh.MeshResource) (*core_xds.IdentitySecret, error)
}
...
func (s *identityCertProvider) Get(ctx context.Context, requestor Identity, mesh *core_mesh.MeshResource) (*core_xds.IdentitySecret, error) {
