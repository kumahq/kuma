...
// While we could reuse CA from enable mTLS backend on a Mesh object there is a problem:
// mTLS on Mesh can be disabled and Envoy Admin communication needs security in place.
