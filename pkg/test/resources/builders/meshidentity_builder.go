...
func (mi *MeshIdentityBuilder) WithBundledAutoGenerated() *MeshIdentityBuilder {
	mi.res.Spec.Provider = &meshidentity_api.Provider{
		...
		Bundled: &meshidentity_api.Bundled{
			...
			InsecureAllowSelfSigned: new(true),
...
func (mi *MeshIdentityBuilder) NotSelfSigned() *MeshIdentityBuilder {
	...
	mi.res.Spec.Provider.Bundled.InsecureAllowSelfSigned = new(false)
	return mi
}
...
func (mi *MeshIdentityBuilder) WithSpiffeID(td, path string) *MeshIdentityBuilder {
	...
	mi.res.Spec.SpiffeID.TrustDomain = new(td)
	mi.res.Spec.SpiffeID.Path = new(path)
	return mi
}
