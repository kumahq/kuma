...
func (c *controlPlaneIdCallbacks) OnStreamResponse(_ context.Context, streamID int64, request *envoy_discovery.DiscoveryRequest, response *envoy_discovery.DiscoveryResponse) {
	if c.id != "" {
