...
func convertDelay(delay *policies_api.DelayConf) (*envoy_filter_fault.FaultDelay, error) {
	if delay == nil {
		return nil, nil
	}
...
func convertAbort(abort *policies_api.AbortConf) (*envoy_http_fault.FaultAbort, error) {
	if abort == nil {
		return nil, nil
	}
...
func convertResponseRateLimit(responseBandwidth *policies_api.ResponseBandwidthConf) (*envoy_filter_fault.FaultRateLimit, error) {
