...
import (
	...
	api_v1alpha1 "github.com/kumahq/kuma/v2/pkg/plugins/policies/meshretry/api/v1alpha1"
	k8s_v1alpha1 "github.com/kumahq/kuma/v2/pkg/plugins/policies/meshretry/k8s/v1alpha1"
