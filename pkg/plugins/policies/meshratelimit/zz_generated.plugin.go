...
import (
	...
	api_v1alpha1 "github.com/kumahq/kuma/v2/pkg/plugins/policies/meshratelimit/api/v1alpha1"
	k8s_v1alpha1 "github.com/kumahq/kuma/v2/pkg/plugins/policies/meshratelimit/k8s/v1alpha1"
	plugin_v1alpha1 "github.com/kumahq/kuma/v2/pkg/plugins/policies/meshratelimit/plugin/v1alpha1"
)
