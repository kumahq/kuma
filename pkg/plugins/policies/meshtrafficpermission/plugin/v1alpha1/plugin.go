...
func (p plugin) Apply(rs *core_xds.ResourceSet, ctx xds_context.Context, proxy *core_xds.Proxy) error {
	...
	if proxy.Dataplane == nil || proxy.Dataplane.Spec.IsBuiltinGateway() || proxy.Dataplane.Spec.IsKoyebIngressGateway() || proxy.Dataplane.Spec.IsKoyebGlobalLoadBalancer() {
		return nil
	}
