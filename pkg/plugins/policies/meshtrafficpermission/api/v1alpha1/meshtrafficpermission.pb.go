...
type MeshTrafficPermission_From_Conf_Action int32

const (
	MeshTrafficPermission_From_Conf_ALLOW                  MeshTrafficPermission_From_Conf_Action = 0
	MeshTrafficPermission_From_Conf_DENY                   MeshTrafficPermission_From_Conf_Action = 1
	MeshTrafficPermission_From_Conf_ALLOW_WITH_SHADOW_DENY MeshTrafficPermission_From_Conf_Action = 2
	MeshTrafficPermission_From_Conf_DENY_WITH_SHADOW_ALLOW MeshTrafficPermission_From_Conf_Action = 3
)

// Enum value maps for MeshTrafficPermission_From_Conf_Action.
var (
	MeshTrafficPermission_From_Conf_Action_name = map[int32]string{
		0: "ALLOW",
		1: "DENY",
		2: "ALLOW_WITH_SHADOW_DENY",
		3: "DENY_WITH_SHADOW_ALLOW",
	}
	MeshTrafficPermission_From_Conf_Action_value = map[string]int32{
		"ALLOW":                  0,
		"DENY":                   1,
...
func (x MeshTrafficPermission_From_Conf_Action) Enum() *MeshTrafficPermission_From_Conf_Action {
	p := new(MeshTrafficPermission_From_Conf_Action)
	*p = x
	return p
}

func (x MeshTrafficPermission_From_Conf_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MeshTrafficPermission_From_Conf_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_enumTypes[0].Descriptor()
}

func (MeshTrafficPermission_From_Conf_Action) Type() protoreflect.EnumType {
	return &file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_enumTypes[0]
}

func (x MeshTrafficPermission_From_Conf_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MeshTrafficPermission_From_Conf_Action.Descriptor instead.
func (MeshTrafficPermission_From_Conf_Action) EnumDescriptor() ([]byte, []int) {
	return file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_rawDescGZIP(), []int{0, 0, 0, 0}
}
...
type MeshTrafficPermission_From struct {
	...
	// 'targetRef'
	Default *MeshTrafficPermission_From_Conf `protobuf:"bytes,2,opt,name=default,proto3" json:"default,omitempty"`
}
...
func (x *MeshTrafficPermission_From) GetDefault() *MeshTrafficPermission_From_Conf {
	if x != nil {
		return x.Default
	}
	return nil
...
type MeshTrafficPermission_From_Conf struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MeshTrafficPermission_From_Conf) Reset() {
	*x = MeshTrafficPermission_From_Conf{}
	if protoimpl.UnsafeEnabled {
...
func (x *MeshTrafficPermission_From_Conf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeshTrafficPermission_From_Conf) ProtoMessage() {}

func (x *MeshTrafficPermission_From_Conf) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeshTrafficPermission_From_Conf.ProtoReflect.Descriptor instead.
func (*MeshTrafficPermission_From_Conf) Descriptor() ([]byte, []int) {
	return file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_rawDescGZIP(), []int{0, 0, 0}
}

func (x *MeshTrafficPermission_From_Conf) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
var file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_rawDesc = []byte{
	...
	0x1a, 0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4,
	...
	0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x1a, 0xad, 0x02,
	...
	0x65, 0x74, 0x52, 0x65, 0x66, 0x12, 0x6f, 0x0a, 0x07, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x55, 0x2e, 0x6b, 0x75, 0x6d, 0x61, 0x2e, 0x70, 0x6c,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x6f, 0x6d, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x52, 0x07, 0x64,
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x1a, 0x75, 0x0a, 0x04, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x16,
	...
	0x48, 0x41, 0x44, 0x4f, 0x57, 0x5f, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x10, 0x03, 0x3a, 0x06, 0xb2,
	0x8c, 0x89, 0xa6, 0x01, 0x00, 0x42, 0x86, 0x01, 0x5a, 0x4e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x69, 0x63, 0x69, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x73, 0x68, 0x74, 0x72, 0x61, 0x66, 0x66, 0x69,
	0x63, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x8a, 0xb5, 0x18, 0x32, 0x50, 0x01, 0xa2, 0x01,
	0x15, 0x4d, 0x65, 0x73, 0x68, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x50, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0xf2, 0x01, 0x15, 0x6d, 0x65, 0x73, 0x68, 0x74, 0x72, 0x61,
	0x66, 0x66, 0x69, 0x63, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x62, 0x06,
...
var file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_goTypes = []interface{}{
	(MeshTrafficPermission_From_Conf_Action)(0), // 0: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From.Conf.Action
	(*MeshTrafficPermission)(nil),               // 1: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission
	(*MeshTrafficPermission_From)(nil),          // 2: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From
	(*MeshTrafficPermission_From_Conf)(nil),     // 3: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From.Conf
...
var file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_depIdxs = []int32{
	...
	2, // 1: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.from:type_name -> kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From
	...
	3, // 3: kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From.default:type_name -> kuma.plugins.policies.meshtrafficpermission.v1alpha1.MeshTrafficPermission.From.Conf
...
func file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_plugins_policies_meshtrafficpermission_api_v1alpha1_meshtrafficpermission_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MeshTrafficPermission_From_Conf); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
