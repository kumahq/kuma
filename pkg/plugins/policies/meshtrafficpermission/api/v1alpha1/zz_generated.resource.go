...
func init() {
	...
	if rawOpenAPISpec != nil {
		...
		// Extract schema from .components.schemas.MeshTrafficPermissionItem
		...
		schemaItem, ok := schemas["MeshTrafficPermissionItem"].(map[string]interface{})
		if !ok {
			panic(fmt.Errorf("MeshTrafficPermissionItem schema not found"))
		}
...
func NewMeshTrafficPermissionResourceList() *model.ResList[*MeshTrafficPermissionResource] {
	return &model.ResList[*MeshTrafficPermissionResource]{NewFn: NewMeshTrafficPermissionResource}
}
