...
func init() {
	...
	if rawOpenAPISpec != nil {
		...
		// Extract schema from .components.schemas.MeshTCPRouteItem
		...
		schemaItem, ok := schemas["MeshTCPRouteItem"].(map[string]interface{})
		if !ok {
			panic(fmt.Errorf("MeshTCPRouteItem schema not found"))
		}
...
func NewMeshTCPRouteResourceList() *model.ResList[*MeshTCPRouteResource] {
	return &model.ResList[*MeshTCPRouteResource]{NewFn: NewMeshTCPRouteResource}
}
