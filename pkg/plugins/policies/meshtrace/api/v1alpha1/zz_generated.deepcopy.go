...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshTraceStatus) DeepCopyInto(out *MeshTraceStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshTraceStatus.
func (in *MeshTraceStatus) DeepCopy() *MeshTraceStatus {
	if in == nil {
		return nil
	}
	out := new(MeshTraceStatus)
	in.DeepCopyInto(out)
	return out
}
