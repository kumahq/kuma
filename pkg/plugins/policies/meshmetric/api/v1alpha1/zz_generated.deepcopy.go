...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeshMetricStatus) DeepCopyInto(out *MeshMetricStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeshMetricStatus.
func (in *MeshMetricStatus) DeepCopy() *MeshMetricStatus {
	if in == nil {
		return nil
	}
	out := new(MeshMetricStatus)
	in.DeepCopyInto(out)
	return out
}
