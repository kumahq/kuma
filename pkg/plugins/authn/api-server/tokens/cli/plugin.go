...
func (*TokenAuthnPlugin) Validate(authConf map[string]string) error {
...
func (*TokenAuthnPlugin) DecorateClient(delegate util_http.Client, authConf map[string]string) (util_http.Client, error) {
