...
var (
	_ k8s_cache.Informers = &informerCache{}
	_ client.Reader       = &informerCache{}
	_ k8s_cache.Cache     = &informerCache{}
)
...
func (ip *informerCache) Get(ctx context.Context, key client.ObjectKey, out client.Object, _ ...client.GetOption) error {
...
func (ip *informerCache) GetInformerForKind(ctx context.Context, gvk schema.GroupVersionKind) (k8s_cache.Informer, error) {
