...
import (
	...
	k8scnicncfio "github.com/kumahq/kuma/v3/pkg/plugins/runtime/k8s/apis/k8s.cni.cncf.io"
)
...
func NewScheme() (*kube_runtime.Scheme, error) {
	...
	if err := gatewayapi_v1.Install(s); err != nil {
		return nil, errors.Wrapf(err, "could not add %v to scheme", gatewayapi_v1.GroupVersion)
	}
