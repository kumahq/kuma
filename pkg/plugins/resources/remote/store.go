...
func (s *remoteStore) Delete(ctx context.Context, res model.Resource, fs ...store.DeleteOptionsFunc) error {
	...
	req, err := http.NewRequestWithContext(ctx, http.MethodDelete, resourceApi.Item(opts.Mesh, opts.Name), http.NoBody)
	if err != nil {
		return err
	}
	statusCode, b, err := s.doRequest(ctx, req)
...
func (s *remoteStore) Get(ctx context.Context, res model.Resource, fs ...store.GetOptionsFunc) error {
	...
	req, err := http.NewRequestWithContext(ctx, http.MethodGet, resourceApi.Item(opts.Mesh, opts.Name), http.NoBody)
	if err != nil {
		return err
	}
	statusCode, b, err := s.doRequest(ctx, req)
...
func (s *remoteStore) List(ctx context.Context, rs model.ResourceList, fs ...store.ListOptionsFunc) error {
	...
	req, err := http.NewRequestWithContext(ctx, http.MethodGet, resourceApi.List(opts.Mesh), http.NoBody)
	if err != nil {
		return err
	}
	query := req.URL.Query()
