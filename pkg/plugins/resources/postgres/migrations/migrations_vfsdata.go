...
var Migrations = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 11, 15, 14, 47, 22, 853195070, time.UTC),
		},
		...
		"/1604501001_adjust_global_resources.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 12, 5, 31, 24, 850285202, time.UTC),
		...
		"/1605012491_add_trigger.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 15, 14, 47, 22, 853119009, time.UTC),
