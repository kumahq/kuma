...
var Migrations = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 11, 10, 12, 48, 24, 306617910, time.UTC),
		},
		...
		"/1604501001_adjust_global_resources.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 10, 12, 40, 5, 460122851, time.UTC),
		...
		"/1605012491_add_trigger.up.sql": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 10, 12, 40, 0, 531466752, time.UTC),
