...
var _ = Describe("listener", func() {
	...
	DescribeTable("handlers accept DeletedFinalStateUnknown tombstones",
		func(operation kuma_events.Op, call func(*listener, interface{})) {
		...
		Entry("add", kuma_events.Create, func(l *listener, obj interface{}) {
			l.OnAdd(obj, false)
		}),
		Entry("update", kuma_events.Update, func(l *listener, obj interface{}) {
			l.OnUpdate(nil, obj)
		}),
		Entry("delete", kuma_events.Delete, func(l *listener, obj interface{}) {
			l.OnDelete(obj)
		}),
	)
})
