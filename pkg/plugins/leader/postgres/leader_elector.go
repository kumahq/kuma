...
import (
	...
	util_channels "github.com/kumahq/kuma/v2/pkg/util/channels"
)
...
func (*KumaPqLockLogger) Error(msg string, args ...any) {
	if len(args) > 0 {
		err, ok := args[0].(error)
		if ok {
...
func (*KumaPqLockLogger) Debug(msg string, args ...any) {
