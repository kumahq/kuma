...
// DefaultProxyTemplate captures the ingress gateway proxy
// profile as a ProxyTemplate resource.
var DefaultProxyTemplate = &mesh_proto.ProxyTemplate{
	Conf: &mesh_proto.ProxyTemplate_Conf{
		Imports: []string{
			metadata.ProfileGlobalLoadBalancerProxy,
		},
	},
}
...
func (r TemplateResolver) GetTemplate(proxy *core_xds.Proxy) *mesh_proto.ProxyTemplate {
	...
	if !proxy.Dataplane.Spec.IsKoyebGlobalLoadBalancer() {
		return nil
	}
