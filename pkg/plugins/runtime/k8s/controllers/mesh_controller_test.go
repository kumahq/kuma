...
<<<<<<< HEAD:pkg/plugins/runtime/k8s/controllers/mesh_defaults_controller_test.go
=======
			K8sStore:        true,
...
>>>>>>> 126ed951a (fix(kubernetes): create builtin CA once (#9124)):pkg/plugins/runtime/k8s/controllers/mesh_controller_test.go
		}
	})
