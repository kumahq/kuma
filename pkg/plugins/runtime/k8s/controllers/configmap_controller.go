...
import (
	...
	"github.com/kumahq/kuma/v3/pkg/plugins/runtime/k8s/controllers/metadata"
...
func (r *ConfigMapReconciler) SetupWithManager(mgr kube_ctrl.Manager) error {
	return kube_ctrl.NewControllerManagedBy(mgr).
		...
		// Dataplane is needed because we can add labels (converted to tags) in runtime that affect service VIP generation
