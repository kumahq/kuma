...
func (c *Executables) InitializeIPv4(
	...
	case nft.Functionality.Rules.ExistingRules && legacy.Functionality.Rules.ExistingRules:
		switch {
		case nft.Functionality.Chains.DockerOutput && legacy.Functionality.Chains.DockerOutput, !nft.Functionality.Chains.DockerOutput && !legacy.Functionality.Chains.DockerOutput:
