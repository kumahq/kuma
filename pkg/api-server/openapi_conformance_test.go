...
var undocumentedRoutes = map[string]string{
	"GET /dataplane-insights":           "cross-mesh list missing from rest.yaml fragment",
	"GET /dataplanes":                   "cross-mesh list missing from rest.yaml fragment",
	"GET /global-secrets":               "cross-mesh list missing from rest.yaml fragment",
	"GET /globalsecrets":                "cross-mesh list missing from rest.yaml fragment",
	"GET /meshaccesslogs":               "cross-mesh list missing from rest.yaml fragment",
	"GET /meshcircuitbreakers":          "cross-mesh list missing from rest.yaml fragment",
	"GET /meshexternalservices":         "cross-mesh list missing from rest.yaml fragment",
	"GET /meshfaultinjections":          "cross-mesh list missing from rest.yaml fragment",
	"GET /meshhealthchecks":             "cross-mesh list missing from rest.yaml fragment",
	"GET /meshhttproutes":               "cross-mesh list missing from rest.yaml fragment",
	"GET /meshidentities":               "cross-mesh list missing from rest.yaml fragment",
	"GET /meshloadbalancingstrategies":  "cross-mesh list missing from rest.yaml fragment",
	"GET /meshmetrics":                  "cross-mesh list missing from rest.yaml fragment",
	"GET /meshmultizoneservices":        "cross-mesh list missing from rest.yaml fragment",
	"GET /meshopentelemetrybackends":    "cross-mesh list missing from rest.yaml fragment",
	"GET /meshpassthroughs":             "cross-mesh list missing from rest.yaml fragment",
	"GET /meshproxypatches":             "cross-mesh list missing from rest.yaml fragment",
	"GET /meshratelimits":               "cross-mesh list missing from rest.yaml fragment",
	"GET /meshretries":                  "cross-mesh list missing from rest.yaml fragment",
	"GET /meshservices":                 "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtcproutes":                "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtimeouts":                 "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtlses":                    "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtraces":                   "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtrafficpermissions":       "cross-mesh list missing from rest.yaml fragment",
	"GET /meshtrusts":                   "cross-mesh list missing from rest.yaml fragment",
	"GET /meshzoneaddresses":            "cross-mesh list missing from rest.yaml fragment",
	"GET /secrets":                      "cross-mesh list missing from rest.yaml fragment",
	"GET /workloads":                    "cross-mesh list missing from rest.yaml fragment",
