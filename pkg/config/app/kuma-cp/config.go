...
type Defaults struct {
	...
	// If true, it creates the default resources for a new Mesh
	CreateMeshResources bool `json:"createMeshResources" envconfig:"kuma_defaults_create_mesh_resources"`
}
