...
type GeneralConfig struct {
	...
	// GracefulShutdownDuration adds a delay to shut down to wait for components to terminate gracefully
	GracefulShutdownDuration config_types.Duration `json:"gracefulShutdownDuration" envconfig:"kuma_general_graceful_shutdown_duration"`
}
...
func DefaultGeneralConfig() *GeneralConfig {
	return &GeneralConfig{
		...
		GracefulShutdownDuration: config_types.Duration{Duration: 3 * time.Second},
	}
}
