...
var _ = Describe("Default config", func() {
	...
	It("should be check against the kuma-cp.defaults.yaml file", func() {
		...
		defaultCfg.GuiServer.Directory = "/path-to-kuma-cp/gui" // default retrieves path to kuma-cp which is not stable in tests
		...
		Expect(defaultCfg).To(Equal(cfg), "The default config generated by Kuma and kuma-cp.defaults.yaml config file are different. Please update the kuma-cp.defaults.yaml file.")
	})
})
