...
var _ = Describe("Config loader", func() {
	...
	DescribeTable("should load config",
		func(given testCase) {
			...
			Expect(cfg.Defaults.AllowAllOutbound).To(BeFalse())
			...
			Expect(cfg.Experimental.ExposeZoneProxyMetrics).To(BeTrue())
...
`,
		...
		Entry("from env variables", testCase{
			envVars: map[string]string{
				...
				"KUMA_DEFAULTS_ALLOW_ALL_OUTBOUND":                                                         "false",
				...
				"KUMA_EXPERIMENTAL_EXPOSE_ZONE_PROXY_METRICS":                                              "true",
