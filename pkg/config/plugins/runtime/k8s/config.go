	...
	return &KubernetesRuntimeConfig{
		...
		Injector: Injector{
			...
			SidecarContainer: SidecarContainer{
				...
				RedirectEnabledIpFamilyMode: "dualstack",
...
type SidecarContainer struct {
	...
	// Deprecated: Use RedirectPortInbound or RedirectEnabledIpFamilyMode instead.
	...
	RedirectEnabledIpFamilyMode string `json:"redirectEnabledIpFamilyMode,omitempty" envconfig:"kuma_runtime_kubernetes_injector_sidecar_container_redirect_enabled_ip_family_mode"`
