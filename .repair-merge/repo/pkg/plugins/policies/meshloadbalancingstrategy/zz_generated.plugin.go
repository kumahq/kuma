...
import (
	...
	api_v1alpha1 "github.com/kumahq/kuma/v3/pkg/plugins/policies/meshloadbalancingstrategy/api/v1alpha1"
	k8s_v1alpha1 "github.com/kumahq/kuma/v3/pkg/plugins/policies/meshloadbalancingstrategy/k8s/v1alpha1"
	plugin_v1alpha1 "github.com/kumahq/kuma/v3/pkg/plugins/policies/meshloadbalancingstrategy/plugin/v1alpha1"
)
