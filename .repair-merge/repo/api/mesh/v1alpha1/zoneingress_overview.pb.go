...
const file_api_mesh_v1alpha1_zoneingress_overview_proto_rawDesc = "" +
	"\n" +
	",api/mesh/v1alpha1/zoneingress_overview.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a$api/mesh/v1alpha1/zone_ingress.proto\x1a,api/mesh/v1alpha1/zone_ingress_insight.proto\"\xfc\x01\n" +
	"\x13ZoneIngressOverview\x12B\n" +
	"\fzone_ingress\x18\x01 \x01(\v2\x1f.kuma.mesh.v1alpha1.ZoneIngressR\vzoneIngress\x12X\n" +
	"\x14zone_ingress_insight\x18\x02 \x01(\v2&.kuma.mesh.v1alpha1.ZoneIngressInsightR\x12zoneIngressInsight:G\xaa\x8c\x89\xa6\x01A\n" +
	"\x1bZoneIngressOverviewResource\x12\x13ZoneIngressOverview\x18\x01\"\x04mesh0\x01`\x01\xa8\x01\x01B-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
