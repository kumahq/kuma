...
const file_api_system_v1alpha1_config_proto_rawDesc = "" +
	...
	"\x0eConfigResource\x12\x06Config\x18\x01\"\x06systemR2model.GlobalToZonesFlag | model.ProvidedByZoneFlag`\x01B/Z-github.com/kumahq/kuma/v3/api/system/v1alpha1b\x06proto3"
