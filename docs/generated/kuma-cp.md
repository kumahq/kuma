...
multizone:
  global:
    kds:
      ...
      maxListQueryElements: 0 # ENV: KUMA_MULTIZONE_GLOBAL_KDS_MAX_LIST_QUERY_ELEMENTS
  zone:
    ...
    kds:
      ...
      # MaxListQueryElements defines maximum number of changed elements before requesting full list of elements from the store.
      maxListQueryElements: 0 # ENV: KUMA_MULTIZONE_ZONE_KDS_MAX_LIST_QUERY_ELEMENTS
