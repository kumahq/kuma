## kumactl get meshloadbalancings

Show MeshLoadBalancing

### Synopsis

Show MeshLoadBalancing entities.

```
kumactl get meshloadbalancings [flags]
```

### Options

```
  -h, --help            help for meshloadbalancings
