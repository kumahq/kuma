## kumactl get meshfaultinjections

Show MeshFaultInjection

### Synopsis

Show MeshFaultInjection entities.

```
kumactl get meshfaultinjections [flags]
```

### Options

```
  -h, --help            help for meshfaultinjections
