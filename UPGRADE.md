...
- Several configuration settings are not supported by the new driver right now, if you needed to tune them please [submit an issue](https://github.com/kumahq/kuma/issues/new) or try removing them.
