import{O as _,bU as h,c6 as p,k as m,cd as l,o,c as r,a,ch as b,w as i,b as e,e as t,bV as w,j as d,bY as y,bZ as f}from"./index.2d238a59.js";const k={name:"EnvironmentSwitcher",components:{KButton:_,KCard:h},data(){return{wizardRoutes:{kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"}}},computed:{...p({environment:"config/getEnvironment"}),instructionsCtaText(){return this.environment==="universal"?"Switch to Kubernetes instructions":"Switch to Universal instructions"},instructionsCtaRoute(){return this.environment==="kubernetes"?{name:"universal-dataplane"}:{name:"kubernetes-dataplane"}}}},u=n=>(y("data-v-6ac9df0a"),n=n(),f(),n),g={class:"wizard-switcher"},S={class:"capitalize"},K={key:0},z={key:0},R=u(()=>t("p",null,[e(`
            ...
            `)],-1)),x={class:"text-center"};function D(n,G,Y,Z,s,q){const c=l("KButton"),v=l("KCard");return o(),r("div",g,[a(v,{ref:"emptyState","cta-is-hidden":"","is-error":!n.environment,class:"my-6"},b({body:i(()=>[n.environment==="kubernetes"?(o(),r("div",K,[n.$route.name===s.wizardRoutes.kubernetes?(o(),r("div",z,[R,e(),t("p",U,[a(c,{to:{name:s.wizardRoutes.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch to`),C,e(`
