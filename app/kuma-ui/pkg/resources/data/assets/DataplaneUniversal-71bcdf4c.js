import{d as q,o as d,a as H,w as l,g as a,Q as de,e as r,u,f as e,r as w,c as D,q as F,h as v,t as m,W as h,a6 as G,F as W,l as B,a7 as O,a5 as b,b as R,p as pe,k as ce}from"./runtime-dom.esm-bundler-60661421.js";import{a as ve,z as M,P as me}from"./production-e492eaa8.js";import{p as he,c as _e,M as we,A as C,a as fe}from"./kongponents.es-8a0bef3e.js";import{Q as De}from"./QueryParameter-70743f73.js";import{t as ke}from"./toYaml-4e00099e.js";import{u as ge}from"./store-2f0e7180.js";import{_ as E}from"./CodeBlock.vue_vue_type_style_index_0_lang-0368c4c6.js";import{S as ye,F as c,E as Se}from"./StepSkeleton-0c4ccc64.js";import{E as be}from"./EnvironmentSwitcher-664e2dc5.js";import{_ as Y}from"./_plugin-vue_export-helper-c27b6911.js";import{u as Ne}from"./index-26866c00.js";function Pe(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const Ie={type:"Dataplane",mesh:null,name:null,networking:{}},xe=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,U)=>(d(),H(u(_e),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(he),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=Y(xe,[["__scopeId","data-v-147bd2ca"]]),i=_=>(pe("data-v-f56f094c"),_=_(),ce(),_),Te={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${K}`)});const z=De.get("step");k.value=z!==null?parseInt(z):0;function ae(o){k.value=o}function te(){x.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await N.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),L.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",Te,[a("div",Ae,[r(ye,{steps:U,"sidebar-content":j,"footer-enabled":x.value===!1,"next-disabled":u(ee),onGoToStep:ae},{general:l(()=>[Me,e(),a("p",null,`
          ...
          `,1),e(),Ce,e(),Ee,e(),Ue,e(),r(u(we),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[$e,e(),(d(!0),v(W,null,B(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,Ve))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[ze,e(),r(u(C),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            by `+m(u(y))+`.
          `,1)]),example:l(()=>[pa,e(),ca,e(),r(E,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:P,language:"yaml"})]),switch:l(()=>[r(be)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const Na=Y(va,[["__scopeId","data-v-f56f094c"]]);export{Na as default};
