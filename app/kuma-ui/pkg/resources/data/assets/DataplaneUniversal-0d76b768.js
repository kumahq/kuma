import{d as q,o as d,a as H,w as l,g as a,Q as de,e as r,u,f as e,r as w,c as D,q as F,h as v,t as m,W as h,a6 as G,F as W,l as B,a7 as O,a5 as b,b as R,p as pe,k as ce}from"./runtime-dom.esm-bundler-9284044f.js";import{m as ve,d as me,M as he,a as M,b as _e}from"./kongponents.es-3ba46133.js";import{a as we,z as E,P as fe}from"./production-4c848fca.js";import{F as c,E as De,S as ke}from"./StepSkeleton-6deb7529.js";import{E as ge}from"./EnvironmentSwitcher-1da88416.js";import{_ as Y}from"./_plugin-vue_export-helper-c27b6911.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-1071fcf3.js";import{u as ye}from"./store-e9d4becb.js";import{u as Se}from"./index-86d1ef67.js";import{Q as be}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,U)=>(d(),H(u(me),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(ve),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=Y(Ie,[["__scopeId","data-v-147bd2ca"]]);function xe(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(pe("data-v-fe363841"),_=_(),ce(),_),Te={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=E(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=E(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=E(`${o}-${K}`)});const z=be.get("step");k.value=z!==null?parseInt(z):0;function ae(o){k.value=o}function te(){x.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await N.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),L.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",Te,[a("div",Ae,[r(ke,{steps:U,"sidebar-content":j,"footer-enabled":x.value===!1,"next-disabled":u(ee),onGoToStep:ae},{general:l(()=>[Me,e(),a("p",null,`
          ...
          `,1),e(),Ee,e(),Ce,e(),Ue,e(),r(u(he),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[$e,e(),(d(!0),v(W,null,B(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,Ve))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[ze,e(),r(u(M),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(d(),v("div",Ze,[x.value===!1?(d(),v("div",Xe,[Je,e(),a("p",null,`
              ...
              `,1),e(),ea,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:u(X)},null,8,["code"]),e(),aa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:u(J)},null,8,["code"])])):R("",!0),e(),r(De,{"loader-function":ne,"should-start":!0,"has-error":g.value,"can-complete":$.value,onHideSiblings:te},{"loading-title":l(()=>[ta]),"loading-content":l(()=>[na]),"complete-title":l(()=>[la]),"complete-content":l(()=>[a("p",null,[e(`
                ...
                `)]),e(),sa,e(),a("p",null,[r(u(M),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[ra]),"error-content":l(()=>[ia]),_:1},8,["has-error","can-complete"])])):(d(),H(u(_e),{key:1,appearance:"danger"},{alertMessage:l(()=>[ua]),_:1}))]),dataplane:l(()=>[da,e(),a("p",null,`
            ...
            by `+m(u(y))+`.
          `,1)]),example:l(()=>[pa,e(),ca,e(),r(C,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:P,language:"yaml"})]),switch:l(()=>[r(ge)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const Na=Y(va,[["__scopeId","data-v-fe363841"]]);export{Na as default};
