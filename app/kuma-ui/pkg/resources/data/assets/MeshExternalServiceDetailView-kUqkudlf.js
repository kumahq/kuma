import{d as g,r as c,o as a,m as n,w as e,b as i,k as m,U as l,e as t,t as d,p,T as z,c as u,F as f,G as h,q as B}from"./index-D7Wwvihu.js";const K={class:"stack"},A={class:"columns"},D=g({__name:"MeshExternalServiceDetailView",props:{data:{}},setup(y){const o=y;return(r,T)=>{const k=c("XAction"),v=c("KTruncate"),_=c("KBadge"),V=c("KCard"),w=c("AppView"),b=c("RouteView");return a(),n(b,{name:"mesh-external-service-detail-view"},{default:e(({can:C})=>[i(w,null,{default:e(()=>[m("div",K,[i(V,null,{default:e(()=>[m("div",A,[C("use zones")&&o.data.zone?(a(),n(l,{key:0},{title:e(()=>[t(`
                Zone
              ...
              `)]),body:e(()=>[i(_,{appearance:"neutral"},{default:e(()=>{var s;return[t(d((s=r.data.spec.tls)!=null&&s.enabled?"Enabled":"Disabled"),1)]}),_:1})]),_:1})):p("",!0),t(),typeof r.data.status.vip<"u"?(a(),n(l,{key:4,class:"ip"},{title:e(()=>[t(`
                VIP
              `)]),body:e(()=>[t(d(r.data.status.vip.ip),1)]),_:1})):p("",!0)])]),_:2},1024)])]),_:2},1024)]),_:1})}}}),E=B(D,[["__scopeId","data-v-f6c305e8"]]);export{E as default};
