import{d as q,o as d,a as H,w as l,g as a,P as ue,e as r,u,f as e,r as _,c as D,y as z,h as v,t as m,S as h,a5 as B,F as G,v as O,a7 as R,a4 as b,b as W,p as de,m as pe}from"./runtime-dom.esm-bundler-0b57de24.js";import{b as ce}from"./vue-router-bad15e32.js";import{m as ve,b as me,D as he,P as M,a as _e}from"./kongponents.es-3b2cea74.js";import{B as C,u as we,k as fe}from"./store-f75d4e4e.js";import{k as De}from"./kumaDpServerUrl-b6bb30c6.js";import{P as ke}from"./constants-31fdaf55.js";import{Q as ge}from"./QueryParameter-70743f73.js";import{t as ye}from"./toYaml-4e00099e.js";import{_ as E}from"./CodeBlock.vue_vue_type_style_index_0_lang-7137c594.js";import{S as Se,F as c,E as be}from"./StepSkeleton-40260a61.js";import{E as Ne}from"./EnvironmentSwitcher-83cf3721.js";import{_ as Y}from"./_plugin-vue_export-helper-c27b6911.js";import"./vuex.esm-bundler-845b9d37.js";import"./_commonjsHelpers-edff4021.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(w){const N=w;return(P,U)=>(d(),H(u(me),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[ue(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(ve),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=Y(Ie,[["__scopeId","data-v-147bd2ca"]]),i=w=>(de("data-v-65eae711"),w=w(),pe(),w),xe={class:"wizard"},Te={class:"wizard__content"},Ae=i(()=>a("h3",null,`
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),J=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});z(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=C(o)}),z(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=C(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=C(`${o}-${j}`)});const F=ge.get("step");k.value=F!==null?parseInt(F):0;function ee(o){k.value=o}function ae(){x.value=!0}async function te(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await fe.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function ne(){I.dispatch("updateSelectedMesh",t.value.meshName),L.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function le(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",xe,[a("div",Te,[r(Se,{steps:P,"sidebar-content":U,"footer-enabled":x.value===!1,"next-disabled":u(J),onGoToStep:ee},{general:l(()=>[Ae,e(),a("p",null,`
          ...
          `,1),e(),Me,e(),Ce,e(),Ee,e(),r(u(he),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ue,e(),(d(!0),v(G,null,O(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,$e))),128))],512),[[B,t.value.meshName]])]),e(),a("div",null,[Ve,e(),r(u(M),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1}),e(),r(c,{"all-inline":"",title:"Protocol","for-attr":"network-dataplane-protocol"},{default:l(()=>[h(a("select",{id:"network-dataplane-protocol","onUpdate:modelValue":s[8]||(s[8]=n=>t.value.univDataplaneNetworkProtocol=n),class:"k-input w-100",name:"network-dataplane-protocol"},[(d(!0),v(G,null,O(K.value.protocols,(n,p)=>(d(),v("option",{key:p,value:n,selected:t.value.univDataplaneNetworkProtocol===n},m(n),9,Ke))),128))],512),[[B,t.value.univDataplaneNetworkProtocol]]),e(),r(f,null,{default:l(()=>[e(`
