import{d as h,E as M,h as m,i as U,o as A,c as R,a as n,w as o,e as s,f as t,u as e,_ as i,I as c,z as _,N as b,O as f,J as v}from"./index-5f1fbf13.js";const l=r=>(b("data-v-88c956eb"),r=r(),f(),r),C={class:"kcard-switcher"},y=l(()=>t("p",null,[s(`
        ...
        `,-1)),T={class:"resource-list-actions mt-4"},g={class:"resource-list-actions mt-4"},k=["href"],S=["href"],x=["href"],D=h({__name:"MeshResources",setup(r){const a=M(),p=m(),u=U(()=>({name:p.getters["config/getEnvironment"]==="universal"?"universal-dataplane":"kubernetes-dataplane"}));return(d,N)=>(A(),R("div",C,[n(e(c),{title:"Create a virtual mesh"},{body:o(()=>[y,s(),t("div",E,[n(e(i),{icon:"plus",appearance:"creation",to:{name:"create-mesh"}},{default:o(()=>[s(`
            Create mesh
          `)]),_:1})])]),_:1}),s(),n(e(c),{title:"Connect data plane proxies"},{body:o(()=>[K,s(),t("div",T,[n(e(i),{to:e(u),appearance:"primary"},{default:o(()=>[s(`
            Get started
        ...
        `,1),s(),t("div",g,[n(e(i),{to:`${e(a)("KUMA_DOCS_URL")}/policies/?${e(a)("KUMA_UTM_QUERY_PARAMS")}`,appearance:"primary",target:"_blank"},{default:o(()=>[s(`
            Explore policies
        ...
        `,1),s(),t("ul",null,[t("li",null,[t("a",{href:`${e(a)("KUMA_DOCS_URL")}/?${e(a)("KUMA_UTM_QUERY_PARAMS")}`,target:"_blank"},_(e(a)("KUMA_PRODUCT_NAME"))+` Documentation
            ...
            `,9,S)]),s(),t("li",null,[t("a",{href:`https://github.com/kumahq/kuma?${e(a)("KUMA_UTM_QUERY_PARAMS")}`,target:"_blank"},_(e(a)("KUMA_PRODUCT_NAME"))+` GitHub Repository
            `,9,x)])])]),_:1})]))}});const O=v(D,[["__scopeId","data-v-88c956eb"]]);export{O as M};
