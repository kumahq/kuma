import{d as m,a as s,o as i,b as g,w as t,Y as n,f as a,e,c as r,t as d,V as u,p as b}from"./index-gsFqX5aX.js";import{T as c}from"./TagList--GcEyqKP.js";const w={key:0,class:"stack-with-borders"},f={key:1,class:"stack-with-borders"},z=m({__name:"DataPlaneInboundSummaryOverviewView",props:{inbound:{},gateway:{}},setup(p){const o=p;return(v,x)=>{const l=s("KBadge"),_=s("AppView"),y=s("RouteView");return i(),g(y,{name:"data-plane-inbound-summary-overview-view"},{default:t(({t:h})=>[e(_,null,{default:t(()=>[o.gateway?(i(),r("div",w,[e(n,{layout:"horizontal"},{title:t(()=>[a(`
            Tags
