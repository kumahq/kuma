import{d as R,a as Y,r as m,c as N,v as $,$ as Z,o as u,j as p,i as e,g as i,w as t,h as a,t as h,e as r,P as Q,U as c,Z as H,F as X,q as J,a0 as k,b as x,V as M,f as y,p as ee,m as ae}from"./index-22d1354e.js";import{Z as v,T as U,V as B}from"./kongponents.es-14a71563.js";import{_ as se}from"./EntityScanner.vue_vue_type_script_setup_true_lang-5b32240f.js";import{E as ne}from"./EnvironmentSwitcher-08151960.js";import{F as _,S as te}from"./StepSkeleton-1df88a26.js";import{f as le}from"./formatForCLI-931cd5c6.js";import{_ as E}from"./CodeBlock.vue_vue_type_style_index_0_lang-ed00a067.js";import{u as oe}from"./store-10af0af9.js";import{u as ie}from"./index-18f05561.js";import{Q as re}from"./QueryParameter-70743f73.js";import{_ as de}from"./_plugin-vue_export-helper-c27b6911.js";import"./toYaml-4e00099e.js";const ue={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,labels:{"kuma.io/sidecar-injection":"enabled"},annotations:{"kuma.io/mesh":null}}},l=f=>(ee("data-v-65556661"),f=f(),ae(),f),ce={class:"wizard"},pe={class:"wizard__content"},me=l(()=>e("h3",null,`
          ...
          `,-1)),we={for:"service-dataplane"},Se=l(()=>e("span",null,`
            ...
            `,-1)),Me={for:"k8s-services-all"},Ve=l(()=>e("span",null,`
                      All Services in Namespace
                    `,-1)),Te={for:"k8s-services-individual"},Ce=l(()=>e("span",null,`
                      Individual Services
                    `,-1)),Ue={key:1},Be={for:"k8s-ingress-kong"},Ee=l(()=>e("span",null,`
                      Kong Ingress
                    `,-1)),Pe={for:"k8s-ingress-other"},Ke=l(()=>e("span",null,`
                      Other Ingress
                    `,-1)),Fe=l(()=>e("p",null,`
                  Please go ahead and deploy the Ingress first, then restart this wizard and select “Existing Ingress”.
                `,-1)),Ae={key:0},je={key:0},qe=l(()=>e("h3",null,`
                Auto-Inject DPP
              `,-1)),ze=l(()=>e("p",null,`
              ...
              `,-1)),Oe=l(()=>e("h4",null,"Kubernetes",-1)),We=l(()=>e("h3",null,"Searching…",-1)),Ge=l(()=>e("p",null,"We are looking for your dataplane.",-1)),Le=l(()=>e("h3",null,"Done!",-1)),Re={key:0},Ye=l(()=>e("p",null,`
                  ...
                  your new Dataplane.
                `,-1)),$e=l(()=>e("h3",null,"Mesh not found",-1)),Ze=l(()=>e("p",null,"We were unable to find your mesh.",-1)),Qe=l(()=>e("p",null,`
                Please return to the first step and make sure to select an
                existing Mesh, or create a new one.
              `,-1)),He=l(()=>e("h3",null,"Dataplane",-1)),Xe=l(()=>e("h3",null,"Example",-1)),Je=l(()=>e("p",null,`
    ...
    tags:
      kuma.io/service: echo`,aa=R({__name:"DataplaneKubernetes",setup(f){const P=ie(),K=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],F=[{name:"dataplane"},{name:"example"},{name:"switch"}],A=Y(),S=oe(),j=m(ue),D=m(0),V=m(!1),I=m(!1),b=m(!1),T=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),q=N(()=>{const d=Object.assign({},j.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return le(d,o)}),z=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});$(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=Z(d)});const C=re.get("step");D.value=C!==null?parseInt(C):0;function O(d){D.value=d}function W(){I.value=!0}async function G(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(T.value=!1,b.value=!1,!(!n||!o))try{const g=await P.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?V.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{T.value=!0}}function L(){S.dispatch("updateSelectedMesh",s.value.meshName),A.push({name:"data-planes-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",ce,[e("div",pe,[i(te,{steps:K,"sidebar-content":F,"footer-enabled":I.value===!1,"next-disabled":z.value,onGoToStep:O},{general:t(()=>[me,a(),e("p",null,`
          ...
          `,1),a(),he,a(),ve,a(),_e,a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(_,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:t(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=o=>s.value.meshName=o),class:"k-input w-100"},[ke,a(),(u(!0),p(X,null,J(r(S).getters.getMeshList.items,o=>(u(),p("option",{key:o.name,value:o.name},h(o.name),9,ye))),128))],512),[[H,s.value.meshName]])]),a(),e("div",null,[ge,a(),i(r(U),{to:{name:"create-mesh"},appearance:"outline"},{default:t(()=>[a(`
            ...
            by `+h(w.value)+`.
          `,1)]),example:t(()=>[Xe,a(),Je,a(),i(E,{id:"onboarding-dpp-kubernetes-example",class:"sample-code-block",code:ea,language:"yaml"})]),switch:t(()=>[i(ne)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ha=de(aa,[["__scopeId","data-v-65556661"]]);export{ha as default};
