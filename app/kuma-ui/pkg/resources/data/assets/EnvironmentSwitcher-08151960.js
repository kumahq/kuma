import{T as _,Z as h}from"./kongponents.es-14a71563.js";import{d as m,u as y,c as b,o,j as a,g as c,y as f,w as i,h as e,i as n,t as g,e as t,f as v,p as k,m as w}from"./index-22d1354e.js";import{u as S}from"./store-10af0af9.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(k("data-v-f74b1174"),d=d(),w(),d),K={class:"wizard-switcher"},U={class:"capitalize"},E={key:0},z={key:0},I=u(()=>n("p",null,[e(`
            ...
            `)],-1)),j={class:"text-center"},D={key:1},q=u(()=>n("p",null,[e(`
              We have detected that you are running on a `),n("strong",null,"Universal environment"),e(`,
            ...
            `)],-1)),A={class:"text-center"},F=m({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},l=y(),p=S(),r=b(()=>p.getters["config/getEnvironment"]);return(G,H)=>(o(),a("div",K,[c(t(h),{ref:"emptyState","cta-is-hidden":"","is-error":!r.value,class:"my-6"},f({body:i(()=>[r.value==="kubernetes"?(o(),a("div",E,[t(l).name===s.kubernetes?(o(),a("div",z,[I,e(),n("p",N,[c(t(_),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
              ...
              `)]),_:1},8,["to"])])])):t(l).name===s.universal?(o(),a("div",D,[q,e(),n("p",A,[c(t(_),{to:{name:s.kubernetes},appearance:"secondary"},{default:i(()=>[e(`
                Switch to
