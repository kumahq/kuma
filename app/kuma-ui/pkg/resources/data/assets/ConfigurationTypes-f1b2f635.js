import{d as b,aq as y,ar as V,as as h,i as x,r as C,a5 as G,j as d,o as p,k as i,w as t,a as s,b as o,f as m,a2 as k,u as r,ap as u,_ as M}from"./index-c8ce0213.js";import{O as P,a as T,b as B}from"./OnboardingPage-878fd6cd.js";const N={class:"graph-list mb-6"},O={class:"radio-button-group"},w=b({__name:"ConfigurationTypes",setup(K){const g=y(),c=V(),_={postgres:h(),memory:c,kubernetes:g},l=x(),e=C("kubernetes");G(function(){e.value=l.getters["config/getConfigurationType"]});const f=d(()=>l.getters["config/getMulticlusterStatus"]?"onboarding-multi-zone":"onboarding-create-mesh"),v=d(()=>_[e.value]);return(U,a)=>(p(),i(B,{"with-image":""},{header:t(()=>[s(P,null,{title:t(()=>[o(`
