import{d as K,o as v,i as E,w as o,e as t,c1 as O,b as e,u as z,cN as W,bY as T,bZ as A,k as x,ck as H,O as j,bU as G,bW as q,c6 as L,cQ as b,c9 as R,cd as h,c as w,a as r,bV as D,cC as c,cD as S,F as N,bX as P,cR as I,cI as f,j as C}from"./index.2d238a59.js";import{j as Y}from"./index.58caa11d.js";import{k as X}from"./kumaDpServerUrl.1e48e09f.js";import{_ as Z}from"./CodeBlock.vue_vue_type_style_index_0_lang.f5cf526a.js";import{F as Q,S as J,E as $}from"./EntityScanner.ee3e8f44.js";import{E as ee}from"./EnvironmentSwitcher.625210aa.js";import"./_commonjsHelpers.f037b798.js";const te=a=>(T("data-v-b945a6f3"),a=a(),A(),a),ae=te(()=>t("a",null,"?",-1)),ne=K({__name:"HelperTooltip",setup(a){return(n,d)=>(v(),E(z(W),{class:"help-icon",trigger:"hover"},{content:o(()=>[t("div",null,[O(n.$slots,"default",{},void 0,!0)])]),default:o(()=>[ae,e()]),_:3}))}});const le=x(ne,[["__scopeId","data-v-b945a6f3"]]),oe={type:"Dataplane",mesh:null,name:null,networking:{}};const ie=`type: Dataplane
mesh: default
name: dp-echo-1
networking:
  address: 10.0.0.1
    ...
    tags:
      ...
      --dataplane-token-file=kuma-token-${a}`},nextDisabled(){const{meshName:a,univDataplaneServiceName:n,univDataplaneId:d,univDataplaneNetworkAddress:m,univDataplaneNetworkServicePort:l,univDataplaneNetworkDPPort:p,univDataplaneNetworkProtocol:k}=this.validate;return a.length?this.$route.query.step==="1"?!(n&&d):this.$route.query.step==="2"?!(m&&l&&p&&k):!1:!0}},watch:{"validate.univDataplaneId"(a){this.validate.univDataplaneId=b(a)},"validate.univDataplaneServiceName"(a){const n=b(a);this.validate.univDataplaneServiceName=n,this.validate.univDataplaneServiceName===""?this.validate.univDataplaneId="":this.validate.univDataplaneId=b(`${a}-${this.randString}`)},"validate.univDataplaneNetworkServicePort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkServicePort=n},"validate.univDataplaneNetworkDPPort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkDPPort=n}},methods:{hideSiblings(){this.hideScannerSiblings=!0},scanForEntity(){const{meshName:a,univDataplaneId:n}=this.validate;this.scanComplete=!1,this.scanError=!1,!(!a||!n)&&R.getDataplaneFromMesh({mesh:a,name:n}).then(d=>{var m;((m=d==null?void 0:d.name)==null?void 0:m.length)>0?(this.isRunning=!0,this.scanFound=!0):this.scanError=!0}).catch(d=>{this.scanError=!0,console.error(d)}).finally(()=>{this.scanComplete=!0})},compeleteDataPlaneSetup(){this.$store.dispatch("updateSelectedMesh",this.validate.meshName),this.$router.push({name:"data-plane-list-view",params:{mesh:this.validate.meshName}})}}},s=a=>(T("data-v-fcc70b3f"),a=a(),A(),a),re={class:"wizard"},de={class:"wizard__content"},pe=s(()=>t("h3",null,`
          ...
          `,-1)),Pe=s(()=>t("p",null,[t("strong",null,"All fields below are required to proceed.")],-1)),Ie=["value","selected"],Ce={key:0},Ee={key:0},Te=s(()=>t("h3",null,`
                Auto-Inject DPP
              `,-1)),Ae=s(()=>t("h4",null,"Generate Dataplane Token",-1)),xe=s(()=>t("h4",null,"Start Dataplane Process",-1)),Me=s(()=>t("h3",null,"Searching\u2026",-1)),Ue=s(()=>t("p",null,"We are looking for your dataplane.",-1)),Fe=s(()=>t("h3",null,"Done!",-1)),Ve={key:0},Be=s(()=>t("p",null,`
                  Proceed to the next step where we will show you
                  your new Dataplane.
                `,-1)),Ke=s(()=>t("h3",null,"Dataplane not found",-1)),Oe=s(()=>t("p",null,"We were unable to find your dataplane.",-1)),ze=s(()=>t("p",null,`
                Please return to the first step and make sure to select an
                existing Mesh, or create a new one.
              `,-1)),We=s(()=>t("h3",null,"Dataplane",-1)),He=s(()=>t("h3",null,"Example",-1)),je=s(()=>t("p",null,`
          ...
          `,1),e(),ue,e(),ce,e(),ve,e(),r(g,{class:"my-6","has-shadow":""},{body:o(()=>[r(u,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:o(()=>[t("div",null,[c(t("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=i=>l.validate.meshName=i),class:"k-input w-100","data-testid":"mesh-select"},[he,e(),(v(!0),w(N,null,P(a.meshes.items,i=>(v(),w("option",{key:i.name,value:i.name},D(i.name),9,me))),128))],512),[[S,l.validate.meshName]])]),e(),t("div",null,[_e,e(),r(k,{to:{name:"create-mesh"},appearance:"secondary"},{default:o(()=>[e(`
            ...
            `)]),_:1})]),_:1}),e(),r(u,{"all-inline":"",title:"Protocol","for-attr":"network-dataplane-protocol"},{default:o(()=>[c(t("select",{id:"network-dataplane-protocol","onUpdate:modelValue":n[10]||(n[10]=i=>l.validate.univDataplaneNetworkProtocol=i),class:"k-input w-100",name:"network-dataplane-protocol"},[(v(!0),w(N,null,P(l.formFields.protocols,(i,B)=>(v(),w("option",{key:B,value:i,selected:l.validate.univDataplaneNetworkProtocol===i},D(i),9,Ie))),128))],512),[[S,l.validate.univDataplaneNetworkProtocol]]),e(),r(_,null,{default:o(()=>[e(`
            ...
            `)]),_:1})]),_:1})]),complete:o(()=>[l.validate.meshName?(v(),w("div",Ce,[l.hideScannerSiblings===!1?(v(),w("div",Ee,[Te,e(),t("p",null,`
              ...
              `,1),e(),Ae,e(),r(y,{id:"code-block-generate-token-command",language:"bash",code:p.generateDpTokenCodeOutput},null,8,["code"]),e(),xe,e(),r(y,{id:"code-block-stard-dp-command",language:"bash",code:p.startDpCodeOutput},null,8,["code"])])):C("",!0),e(),r(M,{"loader-function":p.scanForEntity,"should-start":!0,"has-error":l.scanError,"can-complete":l.scanFound,onHideSiblings:p.hideSiblings},{"loading-title":o(()=>[Me]),"loading-content":o(()=>[Ue]),"complete-title":o(()=>[Fe]),"complete-content":o(()=>[t("p",null,[e(`
                ...
                `)]),e(),Be,e(),t("p",null,[r(k,{appearance:"primary",onClick:p.compeleteDataPlaneSetup},{default:o(()=>[e(`
                    View Your Dataplane
                  `)]),_:1},8,["onClick"])])]),"error-title":o(()=>[Ke]),"error-content":o(()=>[Oe]),_:1},8,["loader-function","has-error","can-complete","onHideSiblings"])])):(v(),E(U,{key:1,appearance:"danger"},{alertMessage:o(()=>[ze]),_:1}))]),dataplane:o(()=>[We,e(),t("p",null,`
            ...
            by `+D(a.title)+`.
          `,1)]),example:o(()=>[He,e(),je,e(),r(y,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:a.$options.EXAMPLE_CODE,language:"yaml"},null,8,["code"])]),switch:o(()=>[r(F)]),_:1},8,["steps","sidebar-content","footer-enabled","next-disabled"])])])}const Je=x(se,[["render",Ge],["__scopeId","data-v-fcc70b3f"]]);export{Je as default};
