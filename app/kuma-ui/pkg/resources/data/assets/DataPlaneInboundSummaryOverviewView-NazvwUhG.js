import{d as h,a as s,o as i,b as g,w as t,T as n,f as a,e,c as l,t as d,p as b}from"./index-CqXGLTiP.js";import{T as u}from"./TagList-PazD_DgS.js";import{T as c}from"./TextWithCopyButton-3lrZWnHN.js";import"./CopyButton-MfTze-YE.js";import"./index-FZCiQto1.js";const w={key:0,class:"stack-with-borders"},f={key:1,class:"stack-with-borders"},C=h({__name:"DataPlaneInboundSummaryOverviewView",props:{inbound:{},gateway:{}},setup(p){const o=p;return(v,x)=>{const r=s("KBadge"),_=s("AppView"),m=s("RouteView");return i(),g(m,{name:"data-plane-inbound-summary-overview-view"},{default:t(({t:y})=>[e(_,null,{default:t(()=>[o.gateway?(i(),l("div",w,[e(n,{layout:"horizontal"},{title:t(()=>[a(`
            Tags
