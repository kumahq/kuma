import{d as q,o as u,a as $,w as l,k as a,n as de,h as r,b as d,g as e,v as pe,q as _,c as D,s as G,N as U,t as v,B as ce,G as m,J as B,e as f,j as O,F as R,O as W,H as N,f as j,p as ve,m as me}from"./index-50754121.js";import{l as he,a as _e,U as fe,S as M,Z as we}from"./kongponents.es-07c2d778.js";import{_ as De}from"./EntityScanner.vue_vue_type_script_setup_true_lang-e9ac5f5d.js";import{E as ke}from"./EnvironmentSwitcher-ad9d1b4b.js";import{S as ge,F as c}from"./StepSkeleton-991a8da9.js";import{h as H,j as ye,k as Se,f as Ne,g as be,_ as Pe}from"./RouteView.vue_vue_type_script_setup_true_lang-bc0afbf3.js";import{_ as Ie}from"./RouteTitle.vue_vue_type_script_setup_true_lang-c74dc965.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-559b3ab4.js";import{Q as xe}from"./QueryParameter-70743f73.js";import{t as Te}from"./toYaml-4e00099e.js";const Ae={type:"Dataplane",mesh:null,name:null,networking:{}},Ue=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(h){const b=h;return(P,E)=>(u(),$(d(_e),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:b.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(d(he),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const w=H(Ue,[["__scopeId","data-v-8cf92c6f"]]);function Me(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=h=>(ve("data-v-9f023d47"),h=h(),me(),h),Ce={class:"wizard"},$e={class:"wizard__content"},Ee=i(()=>a("h3",null,`
              ...
              `,-1)),je={for:"service-dataplane"},qe=i(()=>a("span",null,`
                      Service Dataplane
                    `,-1)),He={for:"gateway-dataplane"},Ye=i(()=>a("span",null,`
                      Gateway Dataplane
                    `,-1)),Ze=["disabled"],Ke=i(()=>a("h3",null,`
                Networking
              `,-1)),Le=i(()=>a("p",null,`
                ...
                your service.
              `,-1)),Qe=i(()=>a("p",null,[a("strong",null,"All fields below are required to proceed.")],-1)),Je=["value"],Xe=["value"],ea=["value","selected"],aa={key:0},ta={key:0},na=i(()=>a("h3",null,`
                    Auto-Inject DPP
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});G(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=U(o)}),G(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=U(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=U(`${o}-${Z}`)});const F=xe.get("step");k.value=F!==null?parseInt(F):0;function ae(o){k.value=o}function te(){x.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(z.value=!1,g.value=!1,!(!o||!s))try{((n=(await b.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?V.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{z.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),K.push({name:"data-planes-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(u(),$(Pe,null,{default:l(()=>[r(Ie,{title:d(P)("wizard-universal.routes.item.title")},null,8,["title"]),e(),r(be,null,{default:l(()=>[a("div",Ce,[a("div",$e,[r(ge,{steps:E,"sidebar-content":Y,"footer-enabled":x.value===!1,"next-disabled":ee.value,onGoToStep:ae},{general:l(()=>[Ee,e(),a("p",null,`
              ...
              `,1),e(),Ve,e(),ze,e(),Fe,e(),r(d(fe),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[m(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ge,e(),(u(!0),f(R,null,O(d(I).getters.getMeshList.items,n=>(u(),f("option",{key:n.name,value:n.name},v(n.name),9,Be))),128))],512),[[B,t.value.meshName]])]),e(),a("div",null,[Oe,e(),r(d(M),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
                ...
                `)]),_:1})]),_:1}),e(),r(c,{"all-inline":"",title:"Service Port","for-attr":"network-service-port"},{default:l(()=>[a("input",{id:"network-service-port",value:t.value.univDataplaneNetworkServicePort,type:"text",class:"k-input w-100","data-testid":"service-port",onInput:se},null,40,Xe),e(),r(w,null,{default:l(()=>[e(`
                  The port where your service is listening on the machine.
                `)]),_:1})]),_:1}),e(),r(c,{"all-inline":"",title:"Protocol","for-attr":"network-dataplane-protocol"},{default:l(()=>[m(a("select",{id:"network-dataplane-protocol","onUpdate:modelValue":s[8]||(s[8]=n=>t.value.univDataplaneNetworkProtocol=n),class:"k-input w-100",name:"network-dataplane-protocol"},[(u(!0),f(R,null,O(L.value.protocols,(n,p)=>(u(),f("option",{key:p,value:n,selected:t.value.univDataplaneNetworkProtocol===n},v(n),9,ea))),128))],512),[[B,t.value.univDataplaneNetworkProtocol]]),e(),r(w,null,{default:l(()=>[e(`
                ...
                `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(u(),f("div",aa,[x.value===!1?(u(),f("div",ta,[na,e(),a("p",null,`
                  ...
                  `,1),e(),la,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:J.value},null,8,["code"]),e(),oa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:X.value},null,8,["code"])])):j("",!0),e(),r(De,{"loader-function":ne,"has-error":g.value,"can-complete":V.value,onHideSiblings:te},{"loading-title":l(()=>[sa]),"loading-content":l(()=>[ra]),"complete-title":l(()=>[ia]),"complete-content":l(()=>[a("p",null,[e(`
                    ...
                    `)]),e(),da,e(),a("p",null,[r(d(M),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                        View Your Dataplane
                      `)]),_:1})])]),"error-title":l(()=>[pa]),"error-content":l(()=>[ca]),_:1},8,["has-error","can-complete"])])):(u(),$(d(we),{key:1,appearance:"danger"},{alertMessage:l(()=>[va]),_:1}))]),dataplane:l(()=>[ma,e(),a("p",null,`
                ...
                by `+v(y.value)+`.
              `,1)]),example:l(()=>[ha,e(),_a,e(),r(C,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:fa,language:"yaml"})]),switch:l(()=>[r(ke)]),_:1},8,["footer-enabled","next-disabled"])])])]),_:1})]),_:1}))}});const Ta=H(wa,[["__scopeId","data-v-9f023d47"]]);export{Ta as default};
