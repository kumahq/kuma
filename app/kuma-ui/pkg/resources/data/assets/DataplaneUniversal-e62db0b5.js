import{d as W,o as u,b as q,w as l,i as a,z as ue,g as r,e as c,h as e,a as de,r as f,c as D,v as F,$ as M,j as v,t as m,P as pe,U as h,Z as G,F as B,q as H,a0 as O,V as N,f as R,p as ce,m as ve}from"./index-139fff7d.js";import{o as me,c as he,H as _e,D as U,z as fe}from"./kongponents.es-75dcad6b.js";import{_ as we}from"./EntityScanner.vue_vue_type_script_setup_true_lang-cf32537e.js";import{E as De}from"./EnvironmentSwitcher-d71efd11.js";import{F as p,S as ke}from"./StepSkeleton-fedd9c2e.js";import{_ as j}from"./_plugin-vue_export-helper-c27b6911.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-efda88bb.js";import{u as ge}from"./store-06cadd7e.js";import{u as ye}from"./index-c8239fb4.js";import{Q as Se}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const be={type:"Dataplane",mesh:null,name:null,networking:{}},Pe=W({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const b=_;return(P,$)=>(u(),q(c(he),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:b.placement},{content:l(()=>[a("div",null,[ue(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(c(me),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const w=j(Pe,[["__scopeId","data-v-8cf92c6f"]]);function Ie(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(ce("data-v-f5d99c85"),_=_(),ve(),_),xe={class:"wizard"},Te={class:"wizard__content"},Ae=i(()=>a("h3",null,`
          ...
          `,-1)),Ce=i(()=>a("small",null,"Would you like to see instructions for Kubernetes? Use sidebar to change wizard!",-1)),$e=i(()=>a("option",{disabled:"",value:""},`
                      Select an existing Mesh…
                    `,-1)),Ee=["value"],Ve=i(()=>a("label",{class:"k-input-label mr-4"},`
                    or
                  `,-1)),ze=i(()=>a("h3",null,`
          ...
          `,-1)),Ge={for:"service-dataplane"},Be=i(()=>a("span",null,`
                  Service Dataplane
                `,-1)),He={for:"gateway-dataplane"},Oe=i(()=>a("span",null,`
                  Gateway Dataplane
                `,-1)),Re=["disabled"],We=i(()=>a("h3",null,`
            Networking
          `,-1)),qe=i(()=>a("p",null,`
            ...
            your service.
          `,-1)),je=i(()=>a("p",null,[a("strong",null,"All fields below are required to proceed.")],-1)),Ye=["value"],Ke=["value"],Le=["value","selected"],Ze={key:0},Qe={key:0},Xe=i(()=>a("h3",null,`
                Auto-Inject DPP
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),J=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:d,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(d&&T&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${Y}`)});const z=Se.get("step");k.value=z!==null?parseInt(z):0;function ee(o){k.value=o}function ae(){x.value=!0}async function te(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await b.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?E.value=!0:g.value=!0}catch(d){g.value=!0,console.error(d)}finally{V.value=!0}}function ne(){I.dispatch("updateSelectedMesh",t.value.meshName),K.push({name:"data-planes-list-view",params:{mesh:t.value.meshName}})}function le(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(u(),v("div",xe,[a("div",Te,[r(ke,{steps:P,"sidebar-content":$,"footer-enabled":x.value===!1,"next-disabled":J.value,onGoToStep:ee},{general:l(()=>[Ae,e(),a("p",null,`
          ...
          `,1),e(),Me,e(),Ue,e(),Ce,e(),r(c(_e),{class:"my-6","has-shadow":""},{body:l(()=>[r(p,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[$e,e(),(u(!0),v(B,null,H(c(I).getters.getMeshList.items,n=>(u(),v("option",{key:n.name,value:n.name},m(n.name),9,Ee))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[Ve,e(),r(c(U),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1}),e(),r(p,{"all-inline":"",title:"Service Port","for-attr":"network-service-port"},{default:l(()=>[a("input",{id:"network-service-port",value:t.value.univDataplaneNetworkServicePort,type:"text",class:"k-input w-100","data-testid":"service-port",onInput:oe},null,40,Ke),e(),r(w,null,{default:l(()=>[e(`
              The port where your service is listening on the machine.
            `)]),_:1})]),_:1}),e(),r(p,{"all-inline":"",title:"Protocol","for-attr":"network-dataplane-protocol"},{default:l(()=>[h(a("select",{id:"network-dataplane-protocol","onUpdate:modelValue":s[8]||(s[8]=n=>t.value.univDataplaneNetworkProtocol=n),class:"k-input w-100",name:"network-dataplane-protocol"},[(u(!0),v(B,null,H(L.value.protocols,(n,d)=>(u(),v("option",{key:d,value:n,selected:t.value.univDataplaneNetworkProtocol===n},m(n),9,Le))),128))],512),[[G,t.value.univDataplaneNetworkProtocol]]),e(),r(w,null,{default:l(()=>[e(`
              The protocol of the service.
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(u(),v("div",Ze,[x.value===!1?(u(),v("div",Qe,[Xe,e(),a("p",null,`
              ...
              `,1),e(),Je,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:Q.value},null,8,["code"]),e(),ea,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:X.value},null,8,["code"])])):R("",!0),e(),r(we,{"loader-function":te,"has-error":g.value,"can-complete":E.value,onHideSiblings:ae},{"loading-title":l(()=>[aa]),"loading-content":l(()=>[ta]),"complete-title":l(()=>[na]),"complete-content":l(()=>[a("p",null,[e(`
                  Your Dataplane
                ...
                `)]),e(),oa,e(),a("p",null,[r(c(U),{appearance:"primary",onClick:ne},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[sa]),"error-content":l(()=>[ra]),_:1},8,["has-error","can-complete"])])):(u(),q(c(fe),{key:1,appearance:"danger"},{alertMessage:l(()=>[ia]),_:1}))]),dataplane:l(()=>[ua,e(),a("p",null,`
