import{E as x,y as M,A as B,M as K,ck as V,cn as F,cP as U,k as P,i as p,o as d,j as u,l as e,a as r,w as a,b as n,t as k,m as c,cE as T,F as A,n as q,cQ as v,c as f,v as S,z as y,C as z,D as j}from"./index.0cb244cf.js";import{_ as O}from"./CodeBlock.vue_vue_type_style_index_0_lang.bc379a4d.js";import{f as W}from"./formatForCLI.199be697.js";import{F as L,S as G,E as Y}from"./EntityScanner.116a8b95.js";import{E as R}from"./EnvironmentSwitcher.9e7ebe22.js";import"./_commonjsHelpers.f037b798.js";import"./index.58caa11d.js";const H={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,annotations:{"kuma.io/sidecar-injection":"enabled","kuma.io/mesh":null}}};const X=`apiVersion: 'kuma.io/v1alpha1'
kind: Dataplane
mesh: default
metadata:
  name: dp-echo-1
    ...
    tags:
      kuma.io/service: echo`,Q={name:"DataplaneWizardKubernetes",EXAMPLE_CODE:X,components:{CodeBlock:O,FormFragment:L,StepSkeleton:G,EnvironmentSwitcher:R,EntityScanner:Y,KAlert:M,KButton:B,KCard:K},data(){return{productName:V,schema:H,steps:[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],tabs:[{hash:"#kubernetes",title:"Kubernetes"}],sidebarContent:[{name:"dataplane"},{name:"example"},{name:"switch"}],startScanner:!1,scanFound:!1,hideScannerSiblings:!1,scanError:!1,isComplete:!1,validate:{meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}}},computed:{...F({title:"config/getTagline",version:"config/getVersion",environment:"config/getEnvironment",meshes:"getMeshList"}),codeOutput(){const i=Object.assign({},this.schema),s=this.validate.k8sNamespaceSelection;if(!s)return;i.metadata.name=s,i.metadata.namespace=s,i.metadata.annotations["kuma.io/mesh"]=this.validate.meshName;const g=`" | kubectl apply -f - && kubectl delete pod --all -n ${s}`;return W(i,g)},nextDisabled(){const{k8sNamespaceSelection:i,meshName:s}=this.validate;return s.length?this.$route.query.step==="1"?!i:!1:!0}},watch:{"validate.k8sNamespaceSelection"(i){this.validate.k8sNamespaceSelection=U(i)},$route(){this.$route.query.step===1&&(this.validate.k8sNamespaceSelection?this.nextDisabled=!1:this.nextDisabled=!0)}},methods:{hideSiblings(){this.hideScannerSiblings=!0},scanForEntity(){const s=this.validate.meshName,g=this.validate.k8sNamespaceSelection;this.scanComplete=!1,this.scanError=!1,!(!s||!g)&&P.getDataplaneFromMesh({mesh:s,name:g}).then(_=>{_&&_.name.length>0?(this.isRunning=!0,this.scanFound=!0):this.scanError=!0}).catch(_=>{this.scanError=!0,console.error(_)}).finally(()=>{this.scanComplete=!0})},compeleteDataPlaneSetup(){this.$store.dispatch("updateSelectedMesh",this.validate.meshName),this.$router.push({name:"data-plane-list-view",params:{mesh:this.validate.meshName}})}}},l=i=>(z("data-v-e050c731"),i=i(),j(),i),J={class:"wizard"},Z={class:"wizard__content"},$=l(()=>e("h3",null,`
          ...
          `,1),n(),ee,n(),ne,n(),te,n(),r(h,{class:"my-6","has-shadow":""},{body:a(()=>[r(m,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:a(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=o=>t.validate.meshName=o),class:"k-input w-100"},[se,n(),(d(!0),u(A,null,q(i.meshes.items,o=>(d(),u("option",{key:o.name,value:o.name},k(o.name),9,ae))),128))],512),[[T,t.validate.meshName]])]),n(),e("div",null,[le,n(),r(w,{to:{name:"create-mesh"},appearance:"outline"},{default:a(()=>[n(`
            ...
            by `+k(i.title)+`.
          `,1)]),example:a(()=>[Ae,n(),qe,n(),r(N,{id:"onboarding-dpp-kubernetes-example",code:i.$options.EXAMPLE_CODE,language:"yaml"},null,8,["code"])]),switch:a(()=>[r(E)]),_:1},8,["steps","sidebar-content","footer-enabled","next-disabled"])])])}const He=x(Q,[["render",ze],["__scopeId","data-v-e050c731"]]);export{He as default};
