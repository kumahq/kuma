import{d as Y,l as Q,ai as X,i as $,r as m,j as N,n as H,au as J,o as u,c as p,f as e,a as i,w as t,b as a,y as h,u as r,D as Z,M as v,a7 as c,ab as ee,F as ae,z as se,E as C,av as _,k as x,a8 as M,x as y,X as B,L as ne,N as te,_ as le}from"./index-c8ce0213.js";import{F as k,E as oe,S as ie}from"./StepSkeleton-d3348418.js";import{E as re}from"./EnvironmentSwitcher-f95f8275.js";import{f as de}from"./formatForCLI-931cd5c6.js";import{_ as U}from"./CodeBlock.vue_vue_type_style_index_0_lang-ad640f64.js";import{Q as ue}from"./QueryParameter-70743f73.js";import"./toYaml-4e00099e.js";const ce={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,annotations:{"kuma.io/sidecar-injection":"enabled","kuma.io/mesh":null}}},l=f=>(ne("data-v-f14bf435"),f=f(),te(),f),pe={class:"wizard"},me={class:"wizard__content"},he=l(()=>e("h3",null,`
          ...
          `,-1)),Se={for:"service-dataplane"},De=l(()=>e("span",null,`
            ...
            `,-1)),Ee={for:"k8s-services-all"},Te=l(()=>e("span",null,`
              ...
              `,-1)),We=l(()=>e("h4",null,"Kubernetes",-1)),Le=l(()=>e("h3",null,"Searching…",-1)),Ge=l(()=>e("p",null,"We are looking for your dataplane.",-1)),Re=l(()=>e("h3",null,"Done!",-1)),Ye={key:0},Qe=l(()=>e("p",null,`
          ...
          `,-1)),aa=Y({__name:"DataplaneKubernetes",setup(f){const P=Q(),K=`apiVersion: 'kuma.io/v1alpha1'
kind: Dataplane
mesh: default
metadata:
  name: dp-echo-1
...
networking:
  ...
  - port: 10000
    servicePort: 9000
    tags:
      kuma.io/service: echo`,A=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],F=[{name:"dataplane"},{name:"example"},{name:"switch"}],j=X(),S=$(),z=m(ce),D=m(0),E=m(!1),I=m(!1),b=m(!1),T=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),q=N(()=>{const d=Object.assign({},z.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return de(d,o)}),O=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});H(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=J(d)});const V=ue.get("step");D.value=V!==null?parseInt(V):0;function W(d){D.value=d}function L(){I.value=!0}async function G(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(T.value=!1,b.value=!1,!(!n||!o))try{const g=await P.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?E.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{T.value=!0}}function R(){S.dispatch("updateSelectedMesh",s.value.meshName),j.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",pe,[e("div",me,[i(ie,{steps:A,"sidebar-content":F,"footer-enabled":I.value===!1,"next-disabled":r(O),onGoToStep:W},{general:t(()=>[he,a(),e("p",null,`
            Welcome to the wizard to create a new Dataplane resource in `+h(r(w))+`.
            We will be providing you with a few steps that will get you started.
          `,1),a(),e("p",null,`
            As you know, the `+h(r(Z))+` GUI is read-only.
          `,1),a(),ve,a(),ke,a(),_e,a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(k,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:t(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=o=>s.value.meshName=o),class:"k-input w-100"},[ye,a(),(u(!0),p(ae,null,se(r(S).getters.getMeshList.items,o=>(u(),p("option",{key:o.name,value:o.name},h(o.name),9,ge))),128))],512),[[ee,s.value.meshName]])]),a(),e("div",null,[fe,a(),i(r(C),{to:{name:"create-mesh"},appearance:"outline"},{default:t(()=>[a(`
                    Create a new Mesh
            ...
            `,1),a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(k,{"all-inline":"","equal-cols":"","hide-label-col":""},{default:t(()=>[e("label",Ue,[c(e("input",{id:"k8s-ingress-kong","onUpdate:modelValue":n[7]||(n[7]=o=>s.value.k8sIngressBrand=o),class:"k-input",type:"radio",name:"k8s-ingress-brand",value:"kong-ingress",checked:""},null,512),[[_,s.value.k8sIngressBrand]]),a(),Pe]),a(),e("label",Ke,[c(e("input",{id:"k8s-ingress-other","onUpdate:modelValue":n[8]||(n[8]=o=>s.value.k8sIngressBrand=o),class:"k-input",type:"radio",name:"k8s-ingress-brand",value:"other-ingress"},null,512),[[_,s.value.k8sIngressBrand]]),a(),Ae])]),_:1})]),_:1}),a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(k,{title:"Deployments","for-attr":"k8s-deployment-selection"},{default:t(()=>[c(e("input",{id:"k8s-ingress-deployment-new","onUpdate:modelValue":n[9]||(n[9]=o=>s.value.k8sIngressDeployment=o),type:"text",class:"k-input w-100",placeholder:"your-deployment",required:""},null,512),[[M,s.value.k8sIngressDeployment]])]),_:1})]),_:1}),a(),s.value.k8sIngressBrand==="other-ingress"?(u(),x(r(B),{key:0,appearance:"info"},{alertMessage:t(()=>[Fe]),_:1})):y("",!0)])):y("",!0)]),complete:t(()=>[s.value.meshName?(u(),p("div",je,[I.value===!1?(u(),p("div",ze,[qe,a(),Oe,a(),We,a(),i(U,{id:"code-block-kubernetes-command",class:"mt-3",language:"bash",code:r(q)},null,8,["code"])])):y("",!0),a(),i(oe,{"loader-function":G,"should-start":!0,"has-error":b.value,"can-complete":E.value,onHideSiblings:L},{"loading-title":t(()=>[Le]),"loading-content":t(()=>[Ge]),"complete-title":t(()=>[Re]),"complete-content":t(()=>[e("p",null,[a(`
                  Your Dataplane
