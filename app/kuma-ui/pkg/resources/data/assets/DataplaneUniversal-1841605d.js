import{d as q,o as d,e as j,w as l,i as a,z as de,g as r,b as u,h as e,a as pe,r as w,c as D,v as z,j as v,al as M,t as m,P as ce,a0 as h,a3 as R,F as G,q as B,am as O,a1 as N,f as W,p as ve,m as me}from"./index-e1c5e7d3.js";import{u as he,c as _e,F as we,T as C,R as fe}from"./kongponents.es-76ff1c1d.js";import{_ as De}from"./EntityScanner.vue_vue_type_script_setup_true_lang-317975eb.js";import{E as ke}from"./EnvironmentSwitcher-d874fc65.js";import{S as ge,F as c}from"./StepSkeleton-6fed617c.js";import{_ as H}from"./_plugin-vue_export-helper-c27b6911.js";import{_ as U}from"./CodeBlock.vue_vue_type_style_index_0_lang-891380a6.js";import{u as ye}from"./store-8a8250b5.js";import{u as Se}from"./index-6b720421.js";import{Q as Ne}from"./QueryParameter-70743f73.js";import{t as be}from"./toYaml-4e00099e.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const b=_;return(P,E)=>(d(),j(u(_e),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:b.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(he),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=H(Ie,[["__scopeId","data-v-8cf92c6f"]]);function Te(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(ve("data-v-117032e3"),_=_(),me(),_),xe={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
          ...
          `,-1)),He=i(()=>a("p",null,`
            ...
            your service.
          `,-1)),Ye=i(()=>a("p",null,[a("strong",null,"All fields below are required to proceed.")],-1)),Ke=["value"],Le=["value"],Qe=["value","selected"],Ze={key:0},Xe={key:0},Je=i(()=>a("h3",null,`
                Auto-Inject DPP
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:x,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&x&&S&&A):!1});z(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),z(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${K}`)});const F=Ne.get("step");k.value=F!==null?parseInt(F):0;function ae(o){k.value=o}function te(){T.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await b.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),L.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",xe,[a("div",Ae,[r(ge,{steps:E,"sidebar-content":Y,"footer-enabled":T.value===!1,"next-disabled":u(ee),onGoToStep:ae},{general:l(()=>[Me,e(),a("p",null,`
          ...
          `,1),e(),Ce,e(),Ue,e(),Ee,e(),r(u(we),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[$e,e(),(d(!0),v(G,null,B(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,Ve))),128))],512),[[R,t.value.meshName]])]),e(),a("div",null,[Fe,e(),r(u(C),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(d(),v("div",Ze,[T.value===!1?(d(),v("div",Xe,[Je,e(),a("p",null,`
              ...
              `,1),e(),ea,e(),r(U,{id:"code-block-generate-token-command",language:"bash",code:u(X)},null,8,["code"]),e(),aa,e(),r(U,{id:"code-block-stard-dp-command",language:"bash",code:u(J)},null,8,["code"])])):W("",!0),e(),r(De,{"loader-function":ne,"has-error":g.value,"can-complete":$.value,onHideSiblings:te},{"loading-title":l(()=>[ta]),"loading-content":l(()=>[na]),"complete-title":l(()=>[la]),"complete-content":l(()=>[a("p",null,[e(`
                  Your Dataplane
            ...
            by `+m(u(y))+`.
          `,1)]),example:l(()=>[pa,e(),ca,e(),r(U,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:P,language:"yaml"})]),switch:l(()=>[r(ke)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ba=H(va,[["__scopeId","data-v-117032e3"]]);export{ba as default};
