import{d as j,o as u,a as U,b as l,l as a,q as de,i as r,e as d,h as e,D as pe,s as _,c as D,w as G,_ as M,t as v,L as ce,R as m,X as R,f,k as B,F as O,$ as W,S as N,g as q,p as ve,n as me}from"./index-6fad8e68.js";import{l as he,h as _e,Z as fe,T as $,V as we}from"./kongponents.es-208ec824.js";import{_ as De}from"./EntityScanner.vue_vue_type_script_setup_true_lang-9e5f37b0.js";import{E as ke}from"./EnvironmentSwitcher-810a8991.js";import{S as ge,F as c}from"./StepSkeleton-a9d89c82.js";import{h as H,j as ye,k as Se,f as Ne,g as be,_ as Pe}from"./RouteView.vue_vue_type_script_setup_true_lang-d7cfbc23.js";import{_ as Ie}from"./RouteTitle.vue_vue_type_script_setup_true_lang-d610bc33.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-56641179.js";import{Q as Te}from"./QueryParameter-70743f73.js";import{t as xe}from"./toYaml-4e00099e.js";const Ae={type:"Dataplane",mesh:null,name:null,networking:{}},Me=j({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(h){const b=h;return(P,E)=>(u(),U(d(_e),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:b.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(d(he),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const w=H(Me,[["__scopeId","data-v-8cf92c6f"]]);function $e(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=h=>(ve("data-v-9f023d47"),h=h(),me(),h),Ce={class:"wizard"},Ue={class:"wizard__content"},Ee=i(()=>a("h3",null,`
              ...
              `,-1)),qe={for:"service-dataplane"},je=i(()=>a("span",null,`
                      Service Dataplane
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:x,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&x&&S&&A):!1});G(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),G(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${Y}`)});const F=Te.get("step");k.value=F!==null?parseInt(F):0;function ae(o){k.value=o}function te(){T.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(z.value=!1,g.value=!1,!(!o||!s))try{((n=(await b.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?V.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{z.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),Z.push({name:"data-planes-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(u(),U(Pe,null,{default:l(()=>[r(Ie,{title:d(P)("wizard-universal.routes.item.title")},null,8,["title"]),e(),r(be,null,{default:l(()=>[a("div",Ce,[a("div",Ue,[r(ge,{steps:E,"sidebar-content":L,"footer-enabled":T.value===!1,"next-disabled":ee.value,onGoToStep:ae},{general:l(()=>[Ee,e(),a("p",null,`
              ...
              `,1),e(),Ve,e(),ze,e(),Fe,e(),r(d(fe),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[m(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ge,e(),(u(!0),f(O,null,B(d(I).getters.getMeshList.items,n=>(u(),f("option",{key:n.name,value:n.name},v(n.name),9,Re))),128))],512),[[R,t.value.meshName]])]),e(),a("div",null,[Be,e(),r(d($),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
                ...
                `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(u(),f("div",aa,[T.value===!1?(u(),f("div",ta,[na,e(),a("p",null,`
                  ...
                  `,1),e(),la,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:X.value},null,8,["code"]),e(),oa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:J.value},null,8,["code"])])):q("",!0),e(),r(De,{"loader-function":ne,"has-error":g.value,"can-complete":V.value,onHideSiblings:te},{"loading-title":l(()=>[sa]),"loading-content":l(()=>[ra]),"complete-title":l(()=>[ia]),"complete-content":l(()=>[a("p",null,[e(`
                      Your Dataplane
                      `),t.value.univDataplaneId?(u(),f("strong",ua,v(t.value.univDataplaneId),1)):q("",!0),e(`
                      was found!
                    `)]),e(),da,e(),a("p",null,[r(d($),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                        View Your Dataplane
                      `)]),_:1})])]),"error-title":l(()=>[pa]),"error-content":l(()=>[ca]),_:1},8,["has-error","can-complete"])])):(u(),U(d(we),{key:1,appearance:"danger"},{alertMessage:l(()=>[va]),_:1}))]),dataplane:l(()=>[ma,e(),a("p",null,`
                ...
                by `+v(y.value)+`.
              `,1)]),example:l(()=>[ha,e(),_a,e(),r(C,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:fa,language:"yaml"})]),switch:l(()=>[r(ke)]),_:1},8,["footer-enabled","next-disabled"])])])]),_:1})]),_:1}))}});const xa=H(wa,[["__scopeId","data-v-9f023d47"]]);export{xa as default};
