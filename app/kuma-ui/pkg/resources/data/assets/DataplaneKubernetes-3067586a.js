import{d as Y,a as $,r as m,c as N,v as Q,j as p,i as e,g as i,w as t,b as r,al as H,o as u,h as a,t as h,P as X,a0 as c,a3 as J,F as Z,q as ee,am as k,e as x,a1 as M,f as y,p as ae,m as se}from"./index-e1c5e7d3.js";import{F as v,T as B,R as E}from"./kongponents.es-76ff1c1d.js";import{_ as ne}from"./EntityScanner.vue_vue_type_script_setup_true_lang-317975eb.js";import{E as te}from"./EnvironmentSwitcher-d874fc65.js";import{S as le,F as _}from"./StepSkeleton-6fed617c.js";import{f as oe}from"./formatForCLI-931cd5c6.js";import{_ as P}from"./CodeBlock.vue_vue_type_style_index_0_lang-891380a6.js";import{u as ie}from"./store-8a8250b5.js";import{u as re}from"./index-6b720421.js";import{Q as de}from"./QueryParameter-70743f73.js";import{_ as ue}from"./_plugin-vue_export-helper-c27b6911.js";import"./toYaml-4e00099e.js";const ce={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,labels:{"kuma.io/sidecar-injection":"enabled"},annotations:{"kuma.io/mesh":null}}},l=f=>(ae("data-v-d94f3464"),f=f(),se(),f),pe={class:"wizard"},me={class:"wizard__content"},he=l(()=>e("h3",null,`
    ...
    tags:
      kuma.io/service: echo`,K=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],A=[{name:"dataplane"},{name:"example"},{name:"switch"}],j=$(),S=ie(),q=m(ce),D=m(0),T=m(!1),I=m(!1),b=m(!1),V=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),z=N(()=>{const d=Object.assign({},q.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return oe(d,o)}),O=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});Q(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=H(d)});const C=de.get("step");D.value=C!==null?parseInt(C):0;function R(d){D.value=d}function W(){I.value=!0}async function G(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(V.value=!1,b.value=!1,!(!n||!o))try{const g=await U.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?T.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{V.value=!0}}function L(){S.dispatch("updateSelectedMesh",s.value.meshName),j.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",pe,[e("div",me,[i(le,{steps:K,"sidebar-content":A,"footer-enabled":I.value===!1,"next-disabled":r(O),onGoToStep:R},{general:t(()=>[he,a(),e("p",null,`
          ...
          `,1),a(),ve,a(),_e,a(),ke,a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(_,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:t(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=o=>s.value.meshName=o),class:"k-input w-100"},[ye,a(),(u(!0),p(Z,null,ee(r(S).getters.getMeshList.items,o=>(u(),p("option",{key:o.name,value:o.name},h(o.name),9,ge))),128))],512),[[J,s.value.meshName]])]),a(),e("div",null,[fe,a(),i(r(B),{to:{name:"create-mesh"},appearance:"outline"},{default:t(()=>[a(`
            ...
            by `+h(r(w))+`.
          `,1)]),example:t(()=>[Ze,a(),ea,a(),i(P,{id:"onboarding-dpp-kubernetes-example",class:"sample-code-block",code:F,language:"yaml"})]),switch:t(()=>[i(te)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ha=ue(aa,[["__scopeId","data-v-d94f3464"]]);export{ha as default};
