import{d as R,a as Y,r as m,c as N,v as $,j as p,i as e,g as i,w as t,al as Q,o as u,h as a,t as h,e as r,P as Z,a0 as c,a3 as H,F as X,q as J,am as k,b as x,a1 as M,f as y,p as ee,m as ae}from"./index-0fbacd76.js";import{z as v,T as B,Z as E}from"./kongponents.es-c741eab8.js";import{_ as se}from"./EntityScanner.vue_vue_type_script_setup_true_lang-13b3fda6.js";import{E as ne}from"./EnvironmentSwitcher-e3cedc7e.js";import{S as te,F as _}from"./StepSkeleton-660df57b.js";import{f as le}from"./formatForCLI-931cd5c6.js";import{_ as P}from"./CodeBlock.vue_vue_type_style_index_0_lang-90b7b8c9.js";import{u as oe}from"./store-5ee7e2bf.js";import{u as ie}from"./index-bc240554.js";import{Q as re}from"./QueryParameter-70743f73.js";import{_ as de}from"./_plugin-vue_export-helper-c27b6911.js";import"./toYaml-4e00099e.js";const ue={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,labels:{"kuma.io/sidecar-injection":"enabled"},annotations:{"kuma.io/mesh":null}}},l=f=>(ee("data-v-d94f3464"),f=f(),ae(),f),ce={class:"wizard"},pe={class:"wizard__content"},me=l(()=>e("h3",null,`
          ...
          `,-1)),we={for:"service-dataplane"},Se=l(()=>e("span",null,`
            ...
            `,-1)),Me={for:"k8s-services-all"},Te=l(()=>e("span",null,`
                    ...
                    `,-1)),Ve={for:"k8s-services-individual"},Ce=l(()=>e("span",null,`
                      Individual Services
                    `,-1)),Be={key:1},Ee={for:"k8s-ingress-kong"},Pe=l(()=>e("span",null,`
                      Kong Ingress
              ...
              `,-1)),Oe=l(()=>e("h4",null,"Kubernetes",-1)),We=l(()=>e("h3",null,"Searching…",-1)),Ge=l(()=>e("p",null,"We are looking for your dataplane.",-1)),Le=l(()=>e("h3",null,"Done!",-1)),Re={key:0},Ye=l(()=>e("p",null,`
                  ...
                  your new Dataplane.
                `,-1)),$e=l(()=>e("h3",null,"Mesh not found",-1)),Qe=l(()=>e("p",null,"We were unable to find your mesh.",-1)),Ze=l(()=>e("p",null,`
    ...
    tags:
      kuma.io/service: echo`,aa=R({__name:"DataplaneKubernetes",setup(f){const U=ie(),K=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],F=[{name:"dataplane"},{name:"example"},{name:"switch"}],z=Y(),S=oe(),A=m(ue),D=m(0),T=m(!1),I=m(!1),b=m(!1),V=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),j=N(()=>{const d=Object.assign({},A.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return le(d,o)}),q=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});$(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=Q(d)});const C=re.get("step");D.value=C!==null?parseInt(C):0;function O(d){D.value=d}function W(){I.value=!0}async function G(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(V.value=!1,b.value=!1,!(!n||!o))try{const g=await U.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?T.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{V.value=!0}}function L(){S.dispatch("updateSelectedMesh",s.value.meshName),z.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",ce,[e("div",pe,[i(te,{steps:K,"sidebar-content":F,"footer-enabled":I.value===!1,"next-disabled":q.value,onGoToStep:O},{general:t(()=>[me,a(),e("p",null,`
          ...
          `,1),a(),he,a(),ve,a(),_e,a(),i(r(v),{class:"my-6","has-shadow":""},{body:t(()=>[i(_,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:t(()=>[e("div",null,[c(e("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=o=>s.value.meshName=o),class:"k-input w-100"},[ke,a(),(u(!0),p(X,null,J(r(S).getters.getMeshList.items,o=>(u(),p("option",{key:o.name,value:o.name},h(o.name),9,ye))),128))],512),[[H,s.value.meshName]])]),a(),e("div",null,[ge,a(),i(r(B),{to:{name:"create-mesh"},appearance:"outline"},{default:t(()=>[a(`
            ...
            by `+h(w.value)+`.
          `,1)]),example:t(()=>[Xe,a(),Je,a(),i(P,{id:"onboarding-dpp-kubernetes-example",class:"sample-code-block",code:ea,language:"yaml"})]),switch:t(()=>[i(ne)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ha=de(aa,[["__scopeId","data-v-d94f3464"]]);export{ha as default};
