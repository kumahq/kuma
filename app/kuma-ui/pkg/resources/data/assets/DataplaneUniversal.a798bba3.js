import{d as K,o as v,c as E,w as o,l as t,J as z,b as e,u as O,cM as H,C as A,D as T,E as x,y as W,A as j,M as G,ck as q,cn as L,cP as S,k as R,i as h,j as w,a as r,t as D,m as c,cE as b,F as N,n as P,cQ as I,v as g,z as C}from"./index.0cb244cf.js";import{j as Y}from"./index.58caa11d.js";import{k as X}from"./kumaDpServerUrl.1e48e09f.js";import{_ as Z}from"./CodeBlock.vue_vue_type_style_index_0_lang.bc379a4d.js";import{F as J,S as Q,E as $}from"./EntityScanner.116a8b95.js";import{E as ee}from"./EnvironmentSwitcher.9e7ebe22.js";import"./_commonjsHelpers.f037b798.js";const te=a=>(A("data-v-b945a6f3"),a=a(),T(),a),ae=te(()=>t("a",null,"?",-1)),ne=K({__name:"HelperTooltip",setup(a){return(n,d)=>(v(),E(O(H),{class:"help-icon",trigger:"hover"},{content:o(()=>[t("div",null,[z(n.$slots,"default",{},void 0,!0)])]),default:o(()=>[ae,e()]),_:3}))}});const le=x(ne,[["__scopeId","data-v-b945a6f3"]]),oe={type:"Dataplane",mesh:null,name:null,networking:{}};const ie=`type: Dataplane
mesh: default
name: dp-echo-1
networking:
  address: 10.0.0.1
  ...
  - port: 10000
    ...
    tags:
      ...
      --dataplane-token-file=kuma-token-${a}`},nextDisabled(){const{meshName:a,univDataplaneServiceName:n,univDataplaneId:d,univDataplaneNetworkAddress:m,univDataplaneNetworkServicePort:l,univDataplaneNetworkDPPort:p,univDataplaneNetworkProtocol:k}=this.validate;return a.length?this.$route.query.step==="1"?!(n&&d):this.$route.query.step==="2"?!(m&&l&&p&&k):!1:!0}},watch:{"validate.univDataplaneId"(a){this.validate.univDataplaneId=S(a)},"validate.univDataplaneServiceName"(a){const n=S(a);this.validate.univDataplaneServiceName=n,this.validate.univDataplaneServiceName===""?this.validate.univDataplaneId="":this.validate.univDataplaneId=S(`${a}-${this.randString}`)},"validate.univDataplaneNetworkServicePort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkServicePort=n},"validate.univDataplaneNetworkDPPort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkDPPort=n}},methods:{hideSiblings(){this.hideScannerSiblings=!0},scanForEntity(){const{meshName:a,univDataplaneId:n}=this.validate;this.scanComplete=!1,this.scanError=!1,!(!a||!n)&&R.getDataplaneFromMesh({mesh:a,name:n}).then(d=>{var m;((m=d==null?void 0:d.name)==null?void 0:m.length)>0?(this.isRunning=!0,this.scanFound=!0):this.scanError=!0}).catch(d=>{this.scanError=!0,console.error(d)}).finally(()=>{this.scanComplete=!0})},compeleteDataPlaneSetup(){this.$store.dispatch("updateSelectedMesh",this.validate.meshName),this.$router.push({name:"data-plane-list-view",params:{mesh:this.validate.meshName}})}}},s=a=>(A("data-v-7bea2500"),a=a(),T(),a),re={class:"wizard"},de={class:"wizard__content"},pe=s(()=>t("h3",null,`
          ...
          `,-1)),ke={for:"service-dataplane"},ge=s(()=>t("span",null,`
                  Service Dataplane
                `,-1)),fe={for:"gateway-dataplane"},ye=s(()=>t("span",null,`
                  Gateway Dataplane
          ...
          `,-1)),Ne=s(()=>t("p",null,`
            ...
            your service.
          `,-1)),Pe=s(()=>t("p",null,[t("strong",null,"All fields below are required to proceed.")],-1)),Ie=["value","selected"],Ce={key:0},Ee={key:0},Ae=s(()=>t("h3",null,`
                Auto-Inject DPP
              `,-1)),Te=s(()=>t("h4",null,"Generate Dataplane Token",-1)),xe=s(()=>t("h4",null,"Start Dataplane Process",-1)),Me=s(()=>t("h3",null,"Searching\u2026",-1)),Ue=s(()=>t("p",null,"We are looking for your dataplane.",-1)),Fe=s(()=>t("h3",null,"Done!",-1)),Ve={key:0},Be=s(()=>t("p",null,`
                  Proceed to the next step where we will show you
                  your new Dataplane.
                `,-1)),Ke=s(()=>t("h3",null,"Dataplane not found",-1)),ze=s(()=>t("p",null,"We were unable to find your dataplane.",-1)),Oe=s(()=>t("p",null,`
                Please return to the first step and make sure to select an
                existing Mesh, or create a new one.
              `,-1)),He=s(()=>t("h3",null,"Dataplane",-1)),We=s(()=>t("h3",null,"Example",-1)),je=s(()=>t("p",null,`
            Below is an example of a Dataplane resource output:
          `,-1));function Ge(a,n,d,m,l,p){const k=h("KButton"),u=h("FormFragment"),f=h("KCard"),_=h("HelperTooltip"),y=h("CodeBlock"),M=h("EntityScanner"),U=h("KAlert"),F=h("EnvironmentSwitcher"),V=h("StepSkeleton");return v(),w("div",re,[t("div",de,[r(V,{steps:l.steps,"sidebar-content":l.sidebarContent,"footer-enabled":l.hideScannerSiblings===!1,"next-disabled":p.nextDisabled},{general:o(()=>[pe,e(),t("p",null,`
          ...
          `,1),e(),ue,e(),ce,e(),ve,e(),r(f,{class:"my-6","has-shadow":""},{body:o(()=>[r(u,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:o(()=>[t("div",null,[c(t("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=i=>l.validate.meshName=i),class:"k-input w-100","data-testid":"mesh-select"},[he,e(),(v(!0),w(N,null,P(a.meshes.items,i=>(v(),w("option",{key:i.name,value:i.name},D(i.name),9,me))),128))],512),[[b,l.validate.meshName]])]),e(),t("div",null,[_e,e(),r(k,{to:{name:"create-mesh"},appearance:"secondary"},{default:o(()=>[e(`
            ...
            `)]),_:1})]),_:1}),e(),r(u,{"all-inline":"","fill-first":"",title:"Data Plane Port","for-attr":"network-dataplane-port"},{default:o(()=>[c(t("input",{id:"network-dataplane-port","onUpdate:modelValue":n[7]||(n[7]=i=>l.validate.univDataplaneNetworkDPPort=i),type:"text",class:"k-input w-100","data-testid":"network-dataplane-port"},null,512),[[g,l.validate.univDataplaneNetworkDPPort]]),e(),r(_,null,{default:o(()=>[e(`
            ...
            `)]),_:1})]),_:1}),e(),r(u,{"all-inline":"",title:"Service Port","for-attr":"network-service-port"},{default:o(()=>[c(t("input",{id:"network-service-port","onUpdate:modelValue":n[9]||(n[9]=i=>l.validate.univDataplaneNetworkServicePort=i),type:"text",class:"k-input w-100","data-testid":"service-port"},null,512),[[g,l.validate.univDataplaneNetworkServicePort]]),e(),r(_,null,{default:o(()=>[e(`
              The port where your service is listening on the machine.
            `)]),_:1})]),_:1}),e(),r(u,{"all-inline":"",title:"Protocol","for-attr":"network-dataplane-protocol"},{default:o(()=>[c(t("select",{id:"network-dataplane-protocol","onUpdate:modelValue":n[10]||(n[10]=i=>l.validate.univDataplaneNetworkProtocol=i),class:"k-input w-100",name:"network-dataplane-protocol"},[(v(!0),w(N,null,P(l.formFields.protocols,(i,B)=>(v(),w("option",{key:B,value:i,selected:l.validate.univDataplaneNetworkProtocol===i},D(i),9,Ie))),128))],512),[[b,l.validate.univDataplaneNetworkProtocol]]),e(),r(_,null,{default:o(()=>[e(`
              The protocol of the service.
            `)]),_:1})]),_:1})]),complete:o(()=>[l.validate.meshName?(v(),w("div",Ce,[l.hideScannerSiblings===!1?(v(),w("div",Ee,[Ae,e(),t("p",null,`
            ...
            by `+D(a.title)+`.
          `,1)]),example:o(()=>[We,e(),je,e(),r(y,{id:"onboarding-dpp-universal-example",class:"mt-3",code:a.$options.EXAMPLE_CODE,language:"yaml"},null,8,["code"])]),switch:o(()=>[r(F)]),_:1},8,["steps","sidebar-content","footer-enabled","next-disabled"])])])}const Qe=x(se,[["render",Ge],["__scopeId","data-v-7bea2500"]]);export{Qe as default};
