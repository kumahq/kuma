import{T as _,z as h}from"./kongponents.es-74d9733b.js";import{d as m,u as y,c as b,o,j as a,g as c,E as f,w as i,h as e,i as n,t as g,e as t,f as v,p as k,m as w}from"./index-7edb117a.js";import{u as S}from"./store-4d73b926.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(k("data-v-f74b1174"),d=d(),w(),d),z={class:"wizard-switcher"},E={class:"capitalize"},K={key:0},U={key:0},I=u(()=>n("p",null,[e(`
            ...
            `)],-1)),C={class:"text-center"},R={key:1},T={key:0},j=u(()=>n("p",null,[e(`
            ...
            `)],-1)),D={class:"text-center"},q={key:1},A=u(()=>n("p",null,[e(`
              We have detected that you are running on a `),n("strong",null,"Universal environment"),e(`,
            ...
            `)],-1)),F={class:"text-center"},G=m({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},l=y(),p=S(),r=b(()=>p.getters["config/getEnvironment"]);return(H,J)=>(o(),a("div",z,[c(t(h),{ref:"emptyState","cta-is-hidden":"","is-error":!r.value,class:"my-6"},f({body:i(()=>[r.value==="kubernetes"?(o(),a("div",K,[t(l).name===s.kubernetes?(o(),a("div",U,[I,e(),n("p",N,[c(t(_),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
              ...
              `)]),_:1},8,["to"])])])):v("",!0)])):r.value==="universal"?(o(),a("div",R,[t(l).name===s.kubernetes?(o(),a("div",T,[j,e(),n("p",D,[c(t(_),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
