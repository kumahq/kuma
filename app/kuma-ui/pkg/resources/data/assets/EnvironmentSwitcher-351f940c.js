import{T as l,F as h}from"./kongponents.es-c2461f07.js";import{d as m,u as b,c as y,o,j as r,g as c,H as f,b as n,w as i,h as e,i as t,t as g,f as p,p as k,m as w}from"./index-8aa6b41f.js";import{u as S}from"./store-e7d22d49.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(k("data-v-f74b1174"),d=d(),w(),d),K={class:"wizard-switcher"},U={class:"capitalize"},E={key:0},z={key:0},I=u(()=>t("p",null,[e(`
            ...
            `)],-1)),q={class:"text-center"},A=m({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},_=b(),v=S(),a=y(()=>v.getters["config/getEnvironment"]);return(G,J)=>(o(),r("div",K,[c(n(h),{ref:"emptyState","cta-is-hidden":"","is-error":!n(a),class:"my-6"},f({body:i(()=>[n(a)==="kubernetes"?(o(),r("div",E,[n(_).name===s.kubernetes?(o(),r("div",z,[I,e(),t("p",N,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch to`),V,e(`
              ...
              `)]),_:1},8,["to"])])])):n(_).name===s.universal?(o(),r("div",D,[H,e(),t("p",q,[c(n(l),{to:{name:s.kubernetes},appearance:"secondary"},{default:i(()=>[e(`
                Switch to
