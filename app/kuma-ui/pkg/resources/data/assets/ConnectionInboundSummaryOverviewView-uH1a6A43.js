import{d as m,a as s,o as i,b as g,w as t,Z as a,f as o,e,c as l,t as d,W as c,p as b}from"./index-KOnKkPpw.js";import{T as u}from"./TagList-ewDKyP9J.js";const w={key:0,class:"stack-with-borders"},f={key:1,class:"stack-with-borders"},C=m({__name:"ConnectionInboundSummaryOverviewView",props:{inbound:{},gateway:{}},setup(p){const n=p;return(v,x)=>{const r=s("KBadge"),_=s("AppView"),y=s("RouteView");return i(),g(y,{name:"connection-inbound-summary-overview-view"},{default:t(({t:h})=>[e(_,null,{default:t(()=>[n.gateway?(i(),l("div",w,[e(a,{layout:"horizontal"},{title:t(()=>[o(`
            Tags
