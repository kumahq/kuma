import{d as j,o as d,a as q,w as l,g as a,N as ue,e as r,u,f as e,r as _,c as D,s as z,h as v,t as m,S as h,a6 as G,F as B,m as O,a7 as R,a5 as b,b as W,p as de,j as pe}from"./runtime-dom.esm-bundler-fd3ecc5a.js";import{b as ce}from"./vue-router-67937a96.js";import{m as ve,a as me,$ as he,P as M,T as _e}from"./kongponents.es-7ead79da.js";import{x as C}from"./production-8efaeab1.js";import{k as we}from"./kumaApi-08f7fc23.js";import{k as fe}from"./kumaDpServerUrl-b6bb30c6.js";import{P as De}from"./constants-31fdaf55.js";import{Q as ke}from"./QueryParameter-70743f73.js";import{t as ge}from"./toYaml-4e00099e.js";import{u as ye}from"./store-ec4aec64.js";import{_ as E}from"./CodeBlock.vue_vue_type_style_index_0_lang-2bd08d1e.js";import{S as Se,F as c,E as be}from"./StepSkeleton-7106601b.js";import{E as Ne}from"./EnvironmentSwitcher-d3480fc0.js";import{_ as H}from"./_plugin-vue_export-helper-c27b6911.js";import"./vuex.esm-bundler-4e6e06ec.js";import"./_commonjsHelpers-edff4021.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=j({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(w){const N=w;return(P,U)=>(d(),q(u(me),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[ue(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(ve),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=H(Ie,[["__scopeId","data-v-147bd2ca"]]),i=w=>(de("data-v-65eae711"),w=w(),pe(),w),xe={class:"wizard"},Te={class:"wizard__content"},Ae=i(()=>a("h3",null,`
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),J=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});z(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=C(o)}),z(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=C(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=C(`${o}-${Y}`)});const F=ke.get("step");k.value=F!==null?parseInt(F):0;function ee(o){k.value=o}function ae(){x.value=!0}async function te(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await we.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function ne(){I.dispatch("updateSelectedMesh",t.value.meshName),L.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function le(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",xe,[a("div",Te,[r(Se,{steps:P,"sidebar-content":U,"footer-enabled":x.value===!1,"next-disabled":u(J),onGoToStep:ee},{general:l(()=>[Ae,e(),a("p",null,`
          ...
          `,1),e(),Me,e(),Ce,e(),Ee,e(),r(u(he),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ue,e(),(d(!0),v(B,null,O(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,$e))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[Ve,e(),r(u(M),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            by `+m(u(y))+`.
          `,1)]),example:l(()=>[da,e(),pa,e(),r(E,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:N,language:"yaml"})]),switch:l(()=>[r(Ne)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const Ta=H(ca,[["__scopeId","data-v-65eae711"]]);export{Ta as default};
