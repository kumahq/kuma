import{d as j,o as d,k as q,w as l,f as a,Q as de,a as r,u,h as pe,b as e,ax as ce,_ as H,l as ve,ai as me,i as he,r as w,j as D,n as F,au as M,c as v,y as m,D as _e,M as we,a7 as h,ab as G,F as B,z as O,E,av as R,a8 as b,x as W,X as fe,L as De,N as ke}from"./index-be86debd.js";import{F as c,E as ge,S as ye}from"./StepSkeleton-23bc436e.js";import{E as Se}from"./EnvironmentSwitcher-330f2728.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-0ecd0eb5.js";import{Q as be}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=j({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,U)=>(d(),q(u(ce),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(pe),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=H(Ie,[["__scopeId","data-v-147bd2ca"]]);function xe(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(De("data-v-fe363841"),_=_(),ke(),_),Te={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
          ...
          `,-1)),He=i(()=>a("p",null,`
            ...
            your service.
          `,-1)),Le=i(()=>a("p",null,[a("strong",null,"All fields below are required to proceed.")],-1)),Ye=["value"],Ke=["value"],Qe=["value","selected"],Xe={key:0},Ze={key:0},Je=i(()=>a("h3",null,`
                Auto-Inject DPP
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),ee=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:p,univDataplaneNetworkServicePort:T,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(p&&T&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${Y}`)});const z=be.get("step");k.value=z!==null?parseInt(z):0;function ae(o){k.value=o}function te(){x.value=!0}async function ne(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await N.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(p){g.value=!0,console.error(p)}finally{V.value=!0}}function le(){I.dispatch("updateSelectedMesh",t.value.meshName),K.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function se(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(d(),v("div",Te,[a("div",Ae,[r(ye,{steps:U,"sidebar-content":L,"footer-enabled":x.value===!1,"next-disabled":u(ee),onGoToStep:ae},{general:l(()=>[Me,e(),a("p",null,`
          ...
          `,1),e(),Ee,e(),Ce,e(),Ue,e(),r(u(we),{class:"my-6","has-shadow":""},{body:l(()=>[r(c,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[$e,e(),(d(!0),v(B,null,O(u(I).getters.getMeshList.items,n=>(d(),v("option",{key:n.name,value:n.name},m(n.name),9,Ve))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[ze,e(),r(u(E),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(d(),v("div",Xe,[x.value===!1?(d(),v("div",Ze,[Je,e(),a("p",null,`
              ...
              `,1),e(),ea,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:u(Z)},null,8,["code"]),e(),aa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:u(J)},null,8,["code"])])):W("",!0),e(),r(ge,{"loader-function":ne,"should-start":!0,"has-error":g.value,"can-complete":$.value,onHideSiblings:te},{"loading-title":l(()=>[ta]),"loading-content":l(()=>[na]),"complete-title":l(()=>[la]),"complete-content":l(()=>[a("p",null,[e(`
                ...
                `)]),e(),sa,e(),a("p",null,[r(u(E),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[ra]),"error-content":l(()=>[ia]),_:1},8,["has-error","can-complete"])])):(d(),q(u(fe),{key:1,appearance:"danger"},{alertMessage:l(()=>[ua]),_:1}))]),dataplane:l(()=>[da,e(),a("p",null,`
            ...
            by `+m(u(y))+`.
          `,1)]),example:l(()=>[pa,e(),ca,e(),r(C,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:P,language:"yaml"})]),switch:l(()=>[r(Se)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ka=H(va,[["__scopeId","data-v-fe363841"]]);export{ka as default};
