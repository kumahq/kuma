import{d as Y,k as Q,h as X,r as m,i as N,m as $,au as H,o as u,c as p,f as e,a as i,w as t,e as a,z as h,u as r,G as J,I as v,a7 as c,ab as Z,F as ee,A as ae,_ as C,av as k,j as x,a8 as M,y,X as B,N as se,O as ne,aj as te,J as le}from"./index-5f1fbf13.js";import{F as _,E as oe,S as ie}from"./StepSkeleton-85c69e0e.js";import{E as re}from"./EnvironmentSwitcher-618a1042.js";import{f as de}from"./formatForCLI-931cd5c6.js";import{_ as U}from"./CodeBlock.vue_vue_type_style_index_0_lang-e910dc2a.js";import{Q as ue}from"./QueryParameter-70743f73.js";import"./toYaml-4e00099e.js";const ce={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,annotations:{"kuma.io/sidecar-injection":"enabled","kuma.io/mesh":null}}},l=f=>(se("data-v-f14bf435"),f=f(),ne(),f),pe={class:"wizard"},me={class:"wizard__content"},he=l(()=>e("h3",null,`
          ...
          `,-1)),Se={for:"service-dataplane"},De=l(()=>e("span",null,`
            ...
            `,-1)),Te={for:"k8s-services-all"},Ve=l(()=>e("span",null,`
                ...
                `,-1)),je={key:0},Oe={key:0},ze=l(()=>e("h3",null,`
                Auto-Inject DPP
              `,-1)),qe=l(()=>e("p",null,`
...
networking:
  ...
  - port: 10000
    servicePort: 9000
    tags:
      kuma.io/service: echo`,A=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],F=[{name:"dataplane"},{name:"example"},{name:"switch"}],j=te(),S=X(),O=m(ce),D=m(0),T=m(!1),I=m(!1),b=m(!1),V=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),z=N(()=>{const d=Object.assign({},O.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return de(d,o)}),q=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});$(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=H(d)});const E=ue.get("step");D.value=E!==null?parseInt(E):0;function W(d){D.value=d}function G(){I.value=!0}async function L(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(V.value=!1,b.value=!1,!(!n||!o))try{const g=await P.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?T.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{V.value=!0}}function R(){S.dispatch("updateSelectedMesh",s.value.meshName),j.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",pe,[e("div",me,[i(ie,{steps:A,"sidebar-content":F,"footer-enabled":I.value===!1,"next-disabled":r(q),onGoToStep:W},{general:t(()=>[he,a(),e("p",null,`
