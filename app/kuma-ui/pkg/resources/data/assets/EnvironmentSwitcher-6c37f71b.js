import{E as _,z as h}from"./kongponents.es-1cc3ed6f.js";import{d as m,u as y,c as b,o,j as a,g as c,z as f,w as i,h as e,i as n,t as g,e as t,f as v,p as k,m as w}from"./index-e478965d.js";import{u as S}from"./store-c19d7d31.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(k("data-v-f74b1174"),d=d(),w(),d),z={class:"wizard-switcher"},E={class:"capitalize"},K={key:0},U={key:0},I=u(()=>n("p",null,[e(`
            ...
            `)],-1)),F={class:"text-center"},G=m({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},l=y(),p=S(),r=b(()=>p.getters["config/getEnvironment"]);return(H,J)=>(o(),a("div",z,[c(t(h),{ref:"emptyState","cta-is-hidden":"","is-error":!r.value,class:"my-6"},f({body:i(()=>[r.value==="kubernetes"?(o(),a("div",K,[t(l).name===s.kubernetes?(o(),a("div",U,[I,e(),n("p",N,[c(t(_),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch to`),V,e(`
        ...
        Running on `),n("span",E,g(r.value),1)]),key:"0"}:void 0]),1032,["is-error"])]))}});const Q=x(G,[["__scopeId","data-v-f74b1174"]]);export{Q as E};
