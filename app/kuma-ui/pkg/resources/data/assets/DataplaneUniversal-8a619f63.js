import{m as B}from"./vuex.esm-bundler-df5bd11e.js";import{j as K}from"./index-a8834e9c.js";import{m as z,b as O,a as H,P as W,D as q}from"./kongponents.es-3df60cd6.js";import{z as S,k as G}from"./store-2fff246d.js";import{k as j}from"./kumaDpServerUrl-b6bb30c6.js";import{_ as L}from"./CodeBlock.vue_vue_type_style_index_0_lang-525d6c39.js";import{F as R,S as Y,E as X}from"./EntityScanner-9b947b61.js";import{E as Z}from"./EnvironmentSwitcher-03d5770b.js";import{d as J,a as T,w as o,u as b,o as v,g as t,P as Q,e as s,f as e,l as h,h as w,t as D,S as c,a2 as N,F as P,v as I,a4 as C,a1 as k,b as E,p as $,m as ee}from"./runtime-dom.esm-bundler-91b41870.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";import{P as te}from"./constants-31fdaf55.js";import"./_commonjsHelpers-87174ba5.js";const ae=J({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(a){const n=a;return(d,m)=>(v(),T(b(O),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:n.placement},{content:o(()=>[t("div",null,[Q(d.$slots,"default",{},void 0,!0)])]),default:o(()=>[s(b(z),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const ne=x(ae,[["__scopeId","data-v-147bd2ca"]]),le={type:"Dataplane",mesh:null,name:null,networking:{}};const oe=`type: Dataplane
mesh: default
name: dp-echo-1
networking:
  address: 10.0.0.1
  ...
  - port: 10000
    ...
    tags:
      ...
      --dataplane-token-file=kuma-token-${a}`},nextDisabled(){const{meshName:a,univDataplaneServiceName:n,univDataplaneId:d,univDataplaneNetworkAddress:m,univDataplaneNetworkServicePort:l,univDataplaneNetworkDPPort:p,univDataplaneNetworkProtocol:f}=this.validate;return a.length?this.$route.query.step==="1"?!(n&&d):this.$route.query.step==="2"?!(m&&l&&p&&f):!1:!0}},watch:{"validate.univDataplaneId"(a){this.validate.univDataplaneId=S(a)},"validate.univDataplaneServiceName"(a){const n=S(a);this.validate.univDataplaneServiceName=n,this.validate.univDataplaneServiceName===""?this.validate.univDataplaneId="":this.validate.univDataplaneId=S(`${a}-${this.randString}`)},"validate.univDataplaneNetworkServicePort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkServicePort=n},"validate.univDataplaneNetworkDPPort"(a){const n=a.replace(/[a-zA-Z]*$/g,"").trim();this.validate.univDataplaneNetworkDPPort=n}},methods:{hideSiblings(){this.hideScannerSiblings=!0},scanForEntity(){const{meshName:a,univDataplaneId:n}=this.validate;this.scanComplete=!1,this.scanError=!1,!(!a||!n)&&G.getDataplaneFromMesh({mesh:a,name:n}).then(d=>{var m;((m=d==null?void 0:d.name)==null?void 0:m.length)>0?(this.isRunning=!0,this.scanFound=!0):this.scanError=!0}).catch(d=>{this.scanError=!0,console.error(d)}).finally(()=>{this.scanComplete=!0})},compeleteDataPlaneSetup(){this.$store.dispatch("updateSelectedMesh",this.validate.meshName),this.$router.push({name:"data-plane-list-view",params:{mesh:this.validate.meshName}})}}},r=a=>($("data-v-fcc70b3f"),a=a(),ee(),a),se={class:"wizard"},re={class:"wizard__content"},de=r(()=>t("h3",null,`
          ...
          `,-1));function qe(a,n,d,m,l,p){const f=h("KButton"),u=h("FormFragment"),g=h("KCard"),_=h("HelperTooltip"),y=h("CodeBlock"),A=h("EntityScanner"),M=h("KAlert"),U=h("EnvironmentSwitcher"),F=h("StepSkeleton");return v(),w("div",se,[t("div",re,[s(F,{steps:l.steps,"sidebar-content":l.sidebarContent,"footer-enabled":l.hideScannerSiblings===!1,"next-disabled":p.nextDisabled},{general:o(()=>[de,e(),t("p",null,`
          ...
          `,1),e(),pe,e(),ue,e(),ce,e(),s(g,{class:"my-6","has-shadow":""},{body:o(()=>[s(u,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:o(()=>[t("div",null,[c(t("select",{id:"dp-mesh","onUpdate:modelValue":n[0]||(n[0]=i=>l.validate.meshName=i),class:"k-input w-100","data-testid":"mesh-select"},[ve,e(),(v(!0),w(P,null,I(a.meshes.items,i=>(v(),w("option",{key:i.name,value:i.name},D(i.name),9,me))),128))],512),[[N,l.validate.meshName]])]),e(),t("div",null,[he,e(),s(f,{to:{name:"create-mesh"},appearance:"secondary"},{default:o(()=>[e(`
            ...
            by `+D(a.title)+`.
          `,1)]),example:o(()=>[He,e(),We,e(),s(y,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:a.$options.EXAMPLE_CODE,language:"yaml"},null,8,["code"])]),switch:o(()=>[s(U)]),_:1},8,["steps","sidebar-content","footer-enabled","next-disabled"])])])}const at=x(ie,[["render",qe],["__scopeId","data-v-fcc70b3f"]]);export{at as default};
