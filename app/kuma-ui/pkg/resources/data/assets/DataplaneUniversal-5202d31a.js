import{d as j,o as d,k as q,w as l,g as a,R as de,a as r,u,b as pe,e,ax as ce,_ as H,l as ve,i as me,r as w,j as D,n as F,au as M,c as v,y as m,G as he,M as _e,a7 as h,ab as G,F as O,z as R,E,av as B,a8 as b,x as W,X as we,N as fe,O as De,aj as ke}from"./index-cef1317e.js";import{F as c,E as ge,S as ye}from"./StepSkeleton-5158476c.js";import{E as Se}from"./EnvironmentSwitcher-914fdf86.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-e88b9a41.js";import{Q as be}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=j({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,U)=>(d(),q(u(ce),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(pe),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=H(Ie,[["__scopeId","data-v-147bd2ca"]]);function xe(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(fe("data-v-fe363841"),_=_(),De(),_),Te={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
          ...
          `,-1)),Oe={for:"service-dataplane"},Re=i(()=>a("span",null,`
                  Service Dataplane
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(d(),v("div",Xe,[x.value===!1?(d(),v("div",Ze,[Je,e(),a("p",null,`
              ...
              `,1),e(),ea,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:u(Z)},null,8,["code"]),e(),aa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:u(J)},null,8,["code"])])):W("",!0),e(),r(ge,{"loader-function":ne,"should-start":!0,"has-error":g.value,"can-complete":$.value,onHideSiblings:te},{"loading-title":l(()=>[ta]),"loading-content":l(()=>[na]),"complete-title":l(()=>[la]),"complete-content":l(()=>[a("p",null,[e(`
                ...
                `)]),e(),sa,e(),a("p",null,[r(u(E),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[ra]),"error-content":l(()=>[ia]),_:1},8,["has-error","can-complete"])])):(d(),q(u(we),{key:1,appearance:"danger"},{alertMessage:l(()=>[ua]),_:1}))]),dataplane:l(()=>[da,e(),a("p",null,`
