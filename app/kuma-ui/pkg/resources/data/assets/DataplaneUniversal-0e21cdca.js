import{d as H,o as d,k as j,w as l,g as a,R as de,a as r,u,b as pe,e,ax as ce,H as q,l as ve,ai as me,i as he,r as w,j as f,n as F,au as M,c as v,y as m,D as _e,M as we,a7 as h,ab as O,F as G,z as R,E,av as B,a8 as b,x as W,X as De,N as fe,O as ke}from"./index-e096fb01.js";import{F as c,E as ge,S as ye}from"./StepSkeleton-6fec5d7e.js";import{E as Se}from"./EnvironmentSwitcher-6b0a4dd1.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-25903ab0.js";import{Q as be}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const Pe={type:"Dataplane",mesh:null,name:null,networking:{}},Ie=H({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,U)=>(d(),j(u(ce),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[de(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(u(pe),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const D=q(Ie,[["__scopeId","data-v-147bd2ca"]]);function xe(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(fe("data-v-fe363841"),_=_(),ke(),_),Te={class:"wizard"},Ae={class:"wizard__content"},Me=i(()=>a("h3",null,`
          ...
          `,-1)),va=H({__name:"DataplaneUniversal",setup(_){const N=ve(),P=`type: Dataplane
mesh: default
name: dp-echo-1
networking:
  address: 10.0.0.1
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(d(),v("div",Xe,[x.value===!1?(d(),v("div",Ze,[Je,e(),a("p",null,`
              ...
              `,1),e(),ea,e(),r(C,{id:"code-block-generate-token-command",language:"bash",code:u(Z)},null,8,["code"]),e(),aa,e(),r(C,{id:"code-block-stard-dp-command",language:"bash",code:u(J)},null,8,["code"])])):W("",!0),e(),r(ge,{"loader-function":ne,"should-start":!0,"has-error":g.value,"can-complete":$.value,onHideSiblings:te},{"loading-title":l(()=>[ta]),"loading-content":l(()=>[na]),"complete-title":l(()=>[la]),"complete-content":l(()=>[a("p",null,[e(`
                ...
                `)]),e(),sa,e(),a("p",null,[r(u(E),{appearance:"primary",onClick:le},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[ra]),"error-content":l(()=>[ia]),_:1},8,["has-error","can-complete"])])):(d(),j(u(De),{key:1,appearance:"danger"},{alertMessage:l(()=>[ua]),_:1}))]),dataplane:l(()=>[da,e(),a("p",null,`
