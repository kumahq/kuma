import{u as h}from"./vue-router-cf3250ac.js";import{L as l,_ as m}from"./kongponents.es-8abed680.js";import{u as y}from"./store-0511bcbf.js";import{d as f,c as b,o,h as a,e as c,a4 as g,u as n,w as i,f as e,g as t,t as k,b as p,p as w,j as S}from"./runtime-dom.esm-bundler-a6f4ece5.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(w("data-v-6df60a5a"),d=d(),S(),d),K={class:"wizard-switcher"},U={class:"capitalize"},E={key:0},z={key:0},I=u(()=>t("p",null,[e(`
            ...
            `)],-1)),C={class:"text-center"},R={key:1},L={key:0},j=u(()=>t("p",null,[e(`
            ...
            `)],-1)),D={class:"text-center"},T={key:1},q=u(()=>t("p",null,[e(`
              We have detected that you are running on a `),t("strong",null,"Universal environment"),e(`,
            ...
            `)],-1)),A={class:"text-center"},F=f({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},_=h(),v=y(),r=b(()=>v.getters["config/getEnvironment"]);return(G,H)=>(o(),a("div",K,[c(n(m),{ref:"emptyState","cta-is-hidden":"","is-error":!n(r),class:"my-6"},g({body:i(()=>[n(r)==="kubernetes"?(o(),a("div",E,[n(_).name===s.kubernetes?(o(),a("div",z,[I,e(),t("p",N,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
              ...
              `)]),_:1},8,["to"])])])):p("",!0)])):n(r)==="universal"?(o(),a("div",R,[n(_).name===s.kubernetes?(o(),a("div",L,[j,e(),t("p",D,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
                Switch back to Universal instructions
              `)]),_:1},8,["to"])])])):n(_).name===s.universal?(o(),a("div",T,[q,e(),t("p",A,[c(n(l),{to:{name:s.kubernetes},appearance:"secondary"},{default:i(()=>[e(`
                Switch to
