import{d as Y,l as H,ai as Q,i as X,r as m,j as N,n as $,au as J,o as u,c as p,g as e,a as i,w as t,e as a,y as h,u as r,D as Z,M as v,a7 as c,ab as ee,F as ae,z as se,E as C,av as _,k as x,a8 as M,x as y,X as B,N as ne,O as te,H as le}from"./index-e096fb01.js";import{F as k,E as oe,S as ie}from"./StepSkeleton-6fec5d7e.js";import{E as re}from"./EnvironmentSwitcher-6b0a4dd1.js";import{f as de}from"./formatForCLI-931cd5c6.js";import{_ as U}from"./CodeBlock.vue_vue_type_style_index_0_lang-25903ab0.js";import{Q as ue}from"./QueryParameter-70743f73.js";import"./toYaml-4e00099e.js";const ce={apiVersion:"v1",kind:"Namespace",metadata:{name:null,namespace:null,annotations:{"kuma.io/sidecar-injection":"enabled","kuma.io/mesh":null}}},l=f=>(ne("data-v-f14bf435"),f=f(),te(),f),pe={class:"wizard"},me={class:"wizard__content"},he=l(()=>e("h3",null,`
...
networking:
  ...
  - port: 10000
    servicePort: 9000
    tags:
      kuma.io/service: echo`,F=[{label:"General",slug:"general"},{label:"Scope Settings",slug:"scope-settings"},{label:"Install",slug:"complete"}],A=[{name:"dataplane"},{name:"example"},{name:"switch"}],O=Q(),S=X(),j=m(ce),D=m(0),E=m(!1),I=m(!1),b=m(!1),T=m(!1),s=m({meshName:"",k8sDataplaneType:"dataplane-type-service",k8sServices:"all-services",k8sNamespace:"",k8sNamespaceSelection:"",k8sServiceDeployment:"",k8sServiceDeploymentSelection:"",k8sIngressDeployment:"",k8sIngressDeploymentSelection:"",k8sIngressType:"",k8sIngressBrand:"kong-ingress",k8sIngressSelection:""}),w=N(()=>S.getters["config/getTagline"]),z=N(()=>{const d=Object.assign({},j.value),n=s.value.k8sNamespaceSelection;if(!n)return"";d.metadata.name=n,d.metadata.namespace=n,d.metadata.annotations["kuma.io/mesh"]=s.value.meshName;const o=`" | kubectl apply -f - && kubectl delete pod --all -n ${n}`;return de(d,o)}),q=N(()=>{const{k8sNamespaceSelection:d,meshName:n}=s.value;return n.length===0?!0:D.value===1?!d:!1});$(()=>s.value.k8sNamespaceSelection,function(d){s.value.k8sNamespaceSelection=J(d)});const V=ue.get("step");D.value=V!==null?parseInt(V):0;function W(d){D.value=d}function G(){I.value=!0}async function L(){const n=s.value.meshName,o=s.value.k8sNamespaceSelection;if(T.value=!1,b.value=!1,!(!n||!o))try{const g=await P.getDataplaneFromMesh({mesh:n,name:o});g&&g.name.length>0?E.value=!0:b.value=!0}catch(g){b.value=!0,console.error(g)}finally{T.value=!0}}function R(){S.dispatch("updateSelectedMesh",s.value.meshName),O.push({name:"data-plane-list-view",params:{mesh:s.value.meshName}})}return(d,n)=>(u(),p("div",pe,[e("div",me,[i(ie,{steps:F,"sidebar-content":A,"footer-enabled":I.value===!1,"next-disabled":r(q),onGoToStep:W},{general:t(()=>[he,a(),e("p",null,`
