import{d as h,C as M,i as m,j as U,o as A,c as R,a as n,w as o,b as s,f as t,u as e,E as c,M as i,y as _,L as b,N as f,_ as C}from"./index-be86debd.js";const l=r=>(b("data-v-484d96b8"),r=r(),f(),r),v={class:"resource-list"},y=l(()=>t("p",null,[s(`
        ...
        `,-1)),T={class:"resource-list-actions mt-4"},g={class:"resource-list-actions mt-4"},S=["href"],k=["href"],x=["href"],D=h({__name:"MeshResources",setup(r){const a=M(),p=m(),u=U(()=>({name:p.getters["config/getEnvironment"]==="universal"?"universal-dataplane":"kubernetes-dataplane"}));return(d,N)=>(A(),R("div",v,[n(e(i),{title:"Create a virtual mesh"},{body:o(()=>[y,s(),t("div",E,[n(e(c),{icon:"plus",appearance:"creation",to:{name:"create-mesh"}},{default:o(()=>[s(`
            Create mesh
          `)]),_:1})])]),_:1}),s(),n(e(i),{title:"Connect data plane proxies"},{body:o(()=>[K,s(),t("div",T,[n(e(c),{to:e(u),appearance:"primary"},{default:o(()=>[s(`
            Get started
        ...
        `,1),s(),t("div",g,[n(e(c),{to:`${e(a)("KUMA_DOCS_URL")}/policies/?${e(a)("KUMA_UTM_QUERY_PARAMS")}`,appearance:"primary",target:"_blank"},{default:o(()=>[s(`
            Explore policies
