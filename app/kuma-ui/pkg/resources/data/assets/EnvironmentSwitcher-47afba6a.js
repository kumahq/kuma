import{u as h}from"./vue-router-573afc44.js";import{P as l,D as m}from"./kongponents.es-3df60cd6.js";import{u as y}from"./store-eba5eacb.js";import{d as f,c as b,o,h as a,e as c,a0 as g,u as n,w as i,f as e,g as t,t as k,b as p,p as w,m as S}from"./runtime-dom.esm-bundler-91b41870.js";import{_ as x}from"./_plugin-vue_export-helper-c27b6911.js";const u=d=>(w("data-v-6df60a5a"),d=d(),S(),d),K={class:"wizard-switcher"},U={class:"capitalize"},E={key:0},z={key:0},I=u(()=>t("p",null,[e(`
            ...
            `)],-1)),C={class:"text-center"},D={key:1},R={key:0},P=u(()=>t("p",null,[e(`
            ...
            `)],-1)),A={class:"text-center"},F=f({__name:"EnvironmentSwitcher",setup(d){const s={kubernetes:"kubernetes-dataplane",universal:"universal-dataplane"},_=h(),v=y(),r=b(()=>v.getters["config/getEnvironment"]);return(G,H)=>(o(),a("div",K,[c(n(m),{ref:"emptyState","cta-is-hidden":"","is-error":!n(r),class:"my-6"},g({body:i(()=>[n(r)==="kubernetes"?(o(),a("div",E,[n(_).name===s.kubernetes?(o(),a("div",z,[I,e(),t("p",N,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
              ...
              `)]),_:1},8,["to"])])])):p("",!0)])):n(r)==="universal"?(o(),a("div",D,[n(_).name===s.kubernetes?(o(),a("div",R,[P,e(),t("p",T,[c(n(l),{to:{name:s.universal},appearance:"secondary"},{default:i(()=>[e(`
