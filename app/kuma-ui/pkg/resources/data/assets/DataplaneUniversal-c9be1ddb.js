import{d as q,o as u,b as Z,w as l,i as a,z as ue,g as r,e as c,h as e,a as de,r as f,c as D,v as F,$ as M,j as v,t as m,P as pe,U as h,Z as G,F as B,q as O,a0 as R,V as b,f as W,p as ce,m as ve}from"./index-22d1354e.js";import{l as me,b as he,Z as _e,T as U,V as fe}from"./kongponents.es-14a71563.js";import{_ as we}from"./EntityScanner.vue_vue_type_script_setup_true_lang-5b32240f.js";import{E as De}from"./EnvironmentSwitcher-08151960.js";import{F as p,S as ke}from"./StepSkeleton-1df88a26.js";import{_ as j}from"./_plugin-vue_export-helper-c27b6911.js";import{_ as C}from"./CodeBlock.vue_vue_type_style_index_0_lang-ed00a067.js";import{u as ge}from"./store-10af0af9.js";import{u as ye}from"./index-18f05561.js";import{Q as Se}from"./QueryParameter-70743f73.js";import{t as be}from"./toYaml-4e00099e.js";const Ne={type:"Dataplane",mesh:null,name:null,networking:{}},Pe=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const N=_;return(P,V)=>(u(),Z(c(he),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:N.placement},{content:l(()=>[a("div",null,[ue(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(c(me),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const w=j(Pe,[["__scopeId","data-v-8cf92c6f"]]);function Ie(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(ce("data-v-f5d99c85"),_=_(),ve(),_),Te={class:"wizard"},xe={class:"wizard__content"},Ae=i(()=>a("h3",null,`
...
networking:
  ...
  --dataplane-token-file=kuma-token-${o}`}),J=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:d,univDataplaneNetworkServicePort:x,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(d&&x&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${H}`)});const z=Se.get("step");k.value=z!==null?parseInt(z):0;function ee(o){k.value=o}function ae(){T.value=!0}async function te(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(E.value=!1,g.value=!1,!(!o||!s))try{((n=(await N.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(d){g.value=!0,console.error(d)}finally{E.value=!0}}function ne(){I.dispatch("updateSelectedMesh",t.value.meshName),Y.push({name:"data-planes-list-view",params:{mesh:t.value.meshName}})}function le(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(u(),v("div",Te,[a("div",xe,[r(ke,{steps:P,"sidebar-content":V,"footer-enabled":T.value===!1,"next-disabled":J.value,onGoToStep:ee},{general:l(()=>[Ae,e(),a("p",null,`
          ...
          `,1),e(),Me,e(),Ue,e(),Ce,e(),r(c(_e),{class:"my-6","has-shadow":""},{body:l(()=>[r(p,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ve,e(),(u(!0),v(B,null,O(c(I).getters.getMeshList.items,n=>(u(),v("option",{key:n.name,value:n.name},m(n.name),9,$e))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[Ee,e(),r(c(U),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            by `+m(y.value)+`.
          `,1)]),example:l(()=>[da,e(),pa,e(),r(C,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:ca,language:"yaml"})]),switch:l(()=>[r(De)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const Na=j(va,[["__scopeId","data-v-f5d99c85"]]);export{Na as default};
