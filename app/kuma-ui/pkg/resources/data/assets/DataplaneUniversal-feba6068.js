import{d as q,o as u,b as j,w as l,i as a,z as ue,g as r,e as c,h as e,a as de,r as w,c as D,v as F,j as v,al as M,t as m,P as pe,a0 as h,a3 as G,F as B,q as O,am as R,a1 as N,f as W,p as ce,m as ve}from"./index-0fbacd76.js";import{c as me,g as he,z as _e,T as C,Z as we}from"./kongponents.es-c741eab8.js";import{_ as fe}from"./EntityScanner.vue_vue_type_script_setup_true_lang-13b3fda6.js";import{E as De}from"./EnvironmentSwitcher-e3cedc7e.js";import{S as ke,F as p}from"./StepSkeleton-660df57b.js";import{_ as H}from"./_plugin-vue_export-helper-c27b6911.js";import{_ as U}from"./CodeBlock.vue_vue_type_style_index_0_lang-90b7b8c9.js";import{u as ge}from"./store-5ee7e2bf.js";import{u as ye}from"./index-bc240554.js";import{Q as Se}from"./QueryParameter-70743f73.js";import{t as Ne}from"./toYaml-4e00099e.js";const be={type:"Dataplane",mesh:null,name:null,networking:{}},Pe=q({__name:"HelperTooltip",props:{placement:{type:String,required:!1,default:void 0}},setup(_){const b=_;return(P,E)=>(u(),j(c(he),{class:"help-icon",trigger:"click",width:"100%","max-width":"300",placement:b.placement},{content:l(()=>[a("div",null,[ue(P.$slots,"default",{},void 0,!0)])]),default:l(()=>[r(c(me),{icon:"info",color:"var(--grey-500)",size:"16","hide-title":""}),e()]),_:3},8,["placement"]))}});const f=H(Pe,[["__scopeId","data-v-8cf92c6f"]]);function Ie(){return"https://localhost:5678/".replace("localhost",window.location.hostname)}const i=_=>(ce("data-v-117032e3"),_=_(),ve(),_),Te={class:"wizard"},xe={class:"wizard__content"},Ae=i(()=>a("h3",null,`
...
networking:
  ...
  - port: 10000
    servicePort: 9000
    tags:
      kuma.io/service: echo`,va=q({__name:"DataplaneUniversal",setup(_){const b=ye(),P=[{label:"General",slug:"general"},{label:"Topology",slug:"topology"},{label:"Networking",slug:"networking"},{label:"Install",slug:"complete"}],E=[{name:"dataplane"},{name:"example"},{name:"switch"}],Y=Math.random().toString(36).substring(2,8),Z=de(),I=ge(),k=w(0),$=w(!1),T=w(!1),g=w(!1),V=w(!1),t=w({meshName:"",univDataplaneType:"dataplane-type-service",univDataplaneServiceName:"",univDataplaneId:"",univDataplaneCustomIdDisabled:!0,univDataplaneNetworkAddress:null,univDataplaneNetworkServicePort:null,univDataplaneNetworkServiceAddress:"127.0.0.1",univDataplaneNetworkDPPort:null,univDataplaneNetworkProtocol:"tcp"}),K=w({protocols:["tcp","http","grpc"]}),y=D(()=>I.getters["config/getTagline"]),L=D(()=>{const o=Object.assign({},be),{meshName:s,univDataplaneType:n,univDataplaneServiceName:d,univDataplaneId:x,univDataplaneNetworkAddress:S,univDataplaneNetworkServicePort:A,univDataplaneNetworkServiceAddress:se,univDataplaneNetworkDPPort:re,univDataplaneNetworkProtocol:ie}=t.value;return s?(o.name=x,o.mesh=s,n==="dataplane-type-service"?(o.networking.gateway&&delete o.networking.gateway,o.networking={address:S,inbound:[{port:re,servicePort:A,serviceAddress:se,tags:{"kuma.io/service":d,"kuma.io/protocol":ie}}]}):n==="dataplane-type-gateway"&&(o.networking.inbound&&delete o.networking.inbound,o.networking={address:S,gateway:{tags:{"kuma.io/service":d}}}),o):""}),Q=D(()=>{const{univDataplaneId:o}=t.value;return`kumactl generate dataplane-token --name=${o} > kuma-token-${o}`}),X=D(()=>{const{univDataplaneId:o}=t.value;return`kuma-dp run \\
  --cp-address=${Ie()} \\
  --dataplane=${`"${Ne(L.value)}"`} \\
  --dataplane-token-file=kuma-token-${o}`}),J=D(()=>{const{meshName:o,univDataplaneServiceName:s,univDataplaneId:n,univDataplaneNetworkAddress:d,univDataplaneNetworkServicePort:x,univDataplaneNetworkDPPort:S,univDataplaneNetworkProtocol:A}=t.value;return o.length===0?!0:k.value===1?!(s&&n):k.value===2?!(d&&x&&S&&A):!1});F(()=>t.value.univDataplaneId,function(o){t.value.univDataplaneId=M(o)}),F(()=>t.value.univDataplaneServiceName,function(o){t.value.univDataplaneServiceName=M(o),t.value.univDataplaneServiceName===""?t.value.univDataplaneId="":t.value.univDataplaneId=M(`${o}-${Y}`)});const z=Se.get("step");k.value=z!==null?parseInt(z):0;function ee(o){k.value=o}function ae(){T.value=!0}async function te(){var n;const{meshName:o,univDataplaneId:s}=t.value;if(V.value=!1,g.value=!1,!(!o||!s))try{((n=(await b.getDataplaneFromMesh({mesh:o,name:s})).name)==null?void 0:n.length)>0?$.value=!0:g.value=!0}catch(d){g.value=!0,console.error(d)}finally{V.value=!0}}function ne(){I.dispatch("updateSelectedMesh",t.value.meshName),Z.push({name:"data-plane-list-view",params:{mesh:t.value.meshName}})}function le(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkDPPort=n===""?null:Number(n)}function oe(o){const n=o.target.value.replace(/[a-zA-Z]*$/g,"").trim();t.value.univDataplaneNetworkServicePort=n===""?null:Number(n)}return(o,s)=>(u(),v("div",Te,[a("div",xe,[r(ke,{steps:P,"sidebar-content":E,"footer-enabled":T.value===!1,"next-disabled":J.value,onGoToStep:ee},{general:l(()=>[Ae,e(),a("p",null,`
          ...
          `,1),e(),Me,e(),Ce,e(),Ue,e(),r(c(_e),{class:"my-6","has-shadow":""},{body:l(()=>[r(p,{title:"Choose a Mesh","for-attr":"dp-mesh","all-inline":""},{default:l(()=>[a("div",null,[h(a("select",{id:"dp-mesh","onUpdate:modelValue":s[0]||(s[0]=n=>t.value.meshName=n),class:"k-input w-100","data-testid":"mesh-select"},[Ee,e(),(u(!0),v(B,null,O(c(I).getters.getMeshList.items,n=>(u(),v("option",{key:n.name,value:n.name},m(n.name),9,$e))),128))],512),[[G,t.value.meshName]])]),e(),a("div",null,[Ve,e(),r(c(C),{to:{name:"create-mesh"},appearance:"secondary"},{default:l(()=>[e(`
            ...
            `)]),_:1})]),_:1})]),complete:l(()=>[t.value.meshName?(u(),v("div",Le,[T.value===!1?(u(),v("div",Qe,[Xe,e(),a("p",null,`
              ...
              `,1),e(),Je,e(),r(U,{id:"code-block-generate-token-command",language:"bash",code:Q.value},null,8,["code"]),e(),ea,e(),r(U,{id:"code-block-stard-dp-command",language:"bash",code:X.value},null,8,["code"])])):W("",!0),e(),r(fe,{"loader-function":te,"has-error":g.value,"can-complete":$.value,onHideSiblings:ae},{"loading-title":l(()=>[aa]),"loading-content":l(()=>[ta]),"complete-title":l(()=>[na]),"complete-content":l(()=>[a("p",null,[e(`
                ...
                `)]),e(),oa,e(),a("p",null,[r(c(C),{appearance:"primary",onClick:ne},{default:l(()=>[e(`
                    View Your Dataplane
                  `)]),_:1})])]),"error-title":l(()=>[sa]),"error-content":l(()=>[ra]),_:1},8,["has-error","can-complete"])])):(u(),j(c(we),{key:1,appearance:"danger"},{alertMessage:l(()=>[ia]),_:1}))]),dataplane:l(()=>[ua,e(),a("p",null,`
            ...
            by `+m(y.value)+`.
          `,1)]),example:l(()=>[da,e(),pa,e(),r(U,{id:"onboarding-dpp-universal-example",class:"sample-code-block mt-3",code:ca,language:"yaml"})]),switch:l(()=>[r(De)]),_:1},8,["footer-enabled","next-disabled"])])]))}});const ba=H(va,[["__scopeId","data-v-117032e3"]]);export{ba as default};
