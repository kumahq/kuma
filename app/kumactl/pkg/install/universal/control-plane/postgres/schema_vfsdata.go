...
// Schema statically implements the virtual filesystem provided to vfsgen.
var Schema = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 9, 10, 18, 34, 23, 778284305, time.UTC),
		},
		"/resource.sql": &vfsgen۰CompressedFileInfo{
			name:             "resource.sql",
			modTime:          time.Date(2019, 9, 10, 18, 34, 23, 777829185, time.UTC),
