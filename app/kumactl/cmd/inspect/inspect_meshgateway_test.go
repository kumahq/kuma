...
func (t *testMeshGatewayInspectClient) InspectPolicies(ctx context.Context, mesh, name string) (api_server_types.GatewayInspectResult, error) {
...
var _ = DescribeTable("kumactl inspect meshgateway",
	...
	Entry("default output", testCase{
		serverOutput: "inspect-meshgateway.server-response.json",
