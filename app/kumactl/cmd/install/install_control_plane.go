...
// InstallWithConnectionToKubernetes leverage connection to Kubernetes to preserve resources like autogenerated Secrets and not override them on every kumactl install
var InstallWithConnectionToKubernetes = true
...
This command requires that the KUBECONFIG environment is set`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			if InstallWithConnectionToKubernetes {
				var err error
