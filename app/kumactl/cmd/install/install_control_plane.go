...
func newInstallControlPlaneCmd(pctx *kumactl_cmd.RootContext) *cobra.Command {
	...
	cmd.Flags().StringVar(&args.ControlPlane_tls_cert, "tls-cert", args.ControlPlane_tls_cert, "TLS certificate for the admission web hooks implemented by the Kuma Control Plane")
	cmd.Flags().StringVar(&args.ControlPlane_tls_key, "tls-key", args.ControlPlane_tls_key, "TLS key for the admission web hooks implemented by the Kuma Control Plane")
