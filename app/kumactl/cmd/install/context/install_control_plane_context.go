...
func DefaultInstallCpContext() InstallCpContext {
	return InstallCpContext{
		Args: InstallControlPlaneArgs{
			...
			ControlPlane_image_registry:               "registry-1.docker.io",
			ControlPlane_image_repository:             "kumahq/kuma-cp",
			...
			DataPlane_image_registry:                  "registry-1.docker.io",
			DataPlane_image_repository:                "kumahq/kuma-dp",
			DataPlane_image_tag:                       kuma_version.Build.Version,
			DataPlane_initImage_registry:              "registry-1.docker.io",
			DataPlane_initImage_repository:            "kumahq/kuma-init",
