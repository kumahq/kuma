...
import (
	...
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/apply"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/completion"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/config"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/delete"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/export"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/generate"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/get"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/inspect"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/install"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/uninstall"
	"github.com/kumahq/kuma/v2/app/kumactl/cmd/version"
	kumactl_cmd "github.com/kumahq/kuma/v2/app/kumactl/pkg/cmd"
	kumactl_config "github.com/kumahq/kuma/v2/app/kumactl/pkg/config"
