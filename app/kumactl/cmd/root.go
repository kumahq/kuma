	...
	cmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			if kumaBuildVersion == nil {
				cmd.PrintErr("WARNING: Unable to retrieve server version. Cannot confirm kumactl matches server version ")
			} else if kumaBuildVersion != nil && (kumaBuildVersion.Version != kuma_version.Build.Version || kumaBuildVersion.Tagline != kuma_version.Product) {
