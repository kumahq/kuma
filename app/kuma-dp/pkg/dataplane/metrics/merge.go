...
func handleClusterMetric(metricFamily *io_prometheus_client.MetricFamily) error {
	...
	// 'cluster_name' ->
	//   - metric1{envoy_cluster_name="cluster_name-5fb50345",label1="value1"} 10
	//   - metric1{envoy_cluster_name="cluster_name-cfb50345",label1="value1"} 20
	//   - metric1{envoy_cluster_name="cluster_name-409aedd1",label1="value1"} 30
	// 'another_cluster_name' ->
	//   - metric1{envoy_cluster_name="another_cluster_name-5fb50345",response_code="200"} 10
	//   - metric1{envoy_cluster_name="another_cluster_name-5fb50345",response_code="401"} 20
	//   - metric1{envoy_cluster_name="another_cluster_name-cfb50345",response_code="200"} 30
	//   - metric1{envoy_cluster_name="another_cluster_name-409aedd1",response_code="503"} 40
...
// clusterMatch marches cluster names generated by DestinationClusterName.
