...
import (
	...
	externalnameservices "github.com/kumahq/kuma/test/e2e_env/kubernetes/externalname-services"
...
var (
	...
	_ = Describe("ExternalName Services", externalnameservices.ExternalNameServices, Ordered)
