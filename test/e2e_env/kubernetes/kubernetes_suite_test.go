...
var (
	...
	_ = Describe("Gateway - Gateway API", Label("job-0"), gateway.GatewayAPI, Ordered)
	...
	_ = Describe("Membership", Label("job-0"), membership.Membership, Ordered)
	_ = Describe("Container Patch", Label("job-3"), container_patch.ContainerPatch, Ordered)
	_ = Describe("Metrics", Label("job-2"), observability.ApplicationsMetrics, Ordered)
	_ = Describe("Tracing", Label("job-2"), observability.Tracing, Ordered)
	...
	_ = Describe("Traffic Log", Label("job-1"), trafficlog.TCPLogging, Ordered)
	...
	_ = Describe("External Services", Label("job-2"), externalservices.ExternalServices, Ordered)
	_ = Describe("External Services Permissive MTLS", Label("job-2"), externalservices.PermissiveMTLS, Ordered)
