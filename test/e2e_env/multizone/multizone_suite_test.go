...
var (
	...
	_ = Describe("TrafficPermission", Label("job-2"), trafficpermission.TrafficPermission, Ordered)
	_ = Describe("TrafficRoute", Label("job-0"), trafficroute.TrafficRoute, Ordered)
	...
	_ = Describe("External Services", Label("job-0"), externalservices.ExternalServicesOnMultizoneUniversal, Ordered)
	...
	_ = Describe("Virtual Outbounds", Label("job-2"), virtualoutbound.VirtualOutbound, Ordered)
