...
var (
	...
	_ = Describe("HealthCheck panic threshold", Label("job-1"), healthcheck.HealthCheckPanicThreshold, Ordered)
	_ = Describe("HealthCheck", Label("job-1"), healthcheck.Policy)
	...
	_ = Describe("External Services", Label("job-1"), externalservices.Policy, Ordered)
	_ = Describe("External Services through Zone Egress", Label("job-0"), externalservices.ThroughZoneEgress, Ordered)
	...
	_ = Describe("Applications Metrics", Label("job-0"), observability.ApplicationsMetrics, Ordered)
	_ = Describe("Tracing", Label("job-0"), observability.Tracing, Ordered)
	...
	_ = Describe("Traffic Logging", Label("job-1"), trafficlog.TCPLogging, Ordered)
	...
	_ = Describe("Timeout", Label("job-3"), timeout.Policy, Ordered)
	_ = Describe("Retry", Label("job-2"), retry.Policy, Ordered)
	_ = Describe("MeshRetry", Label("job-2"), meshretry.HttpRetry, Ordered)
	_ = Describe("MeshRetry", Label("job-2"), meshretry.GrpcRetry, Ordered)
	_ = Describe("RateLimit", Label("job-2"), ratelimit.Policy, Ordered)
	_ = Describe("ProxyTemplate", Label("job-3"), proxytemplate.ProxyTemplate, Ordered)
	...
	_ = Describe("Matching", Label("job-1"), matching.Matching, Ordered)
	...
	_ = Describe("Traffic Permission", Label("job-2"), trafficpermission.TrafficPermission, Ordered)
	_ = Describe("Traffic Route", Label("job-0"), trafficroute.TrafficRoute, Ordered)
	...
	_ = Describe("Prometheus Metrics", Label("job-3"), observability.PrometheusMetrics, Ordered)
