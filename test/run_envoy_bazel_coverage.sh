...
#
# TODO(yskopets): Copy of https://github.com/envoyproxy/envoy/blob/master/test/run_envoy_bazel_coverage.sh
#                 extended to support MacOS
#
...
[[ -z "${TOOL_CP}" ]] && TOOL_CP="cp"
[[ -z "${TOOL_GREP}" ]] && TOOL_GREP="grep -P"
