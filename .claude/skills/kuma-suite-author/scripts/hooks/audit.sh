#!/usr/bin/env bash
# PostToolUse + PostToolUseFailure audit hook for kuma-suite-author
# Logs every Bash command and Write operation to .suite-author-audit.jsonl
# SA1: post_bash, SA2: post_write, SA3: bash_failure
set -euo pipefail
...
mkdir -p "${audit_dir}"
audit_file="${audit_dir}/.suite-author-audit.jsonl"
