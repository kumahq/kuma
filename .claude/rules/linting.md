...
Enforced by `gci`: standard library → third-party → `github.com/kumahq/kuma/v3`
...
- `github.com/kumahq/kuma/v3/app` from `pkg/`. Architectural boundary (`pkg/` cannot import `app/`)
