...
import (
	...
	"github.com/kumahq/kuma/v3/tools/ci/api-linter/linter"
)
...
func main() {
	...
	commonPackages := []string{"github.com/kumahq/kuma/v3/api/common/v1alpha1"}
	for _, entry := range entries {
		if entry.IsDir() {
			commonPackages = append(commonPackages, "github.com/kumahq/kuma/v3/api/common/v1alpha1/"+entry.Name())
		}
	}
