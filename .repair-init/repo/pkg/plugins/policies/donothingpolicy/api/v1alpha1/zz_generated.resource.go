...
func init() {
	...
	if rawOpenAPISpec != nil {
		...
		// Extract schema from .components.schemas.DoNothingPolicyItem
		...
		schemaItem, ok := schemas["DoNothingPolicyItem"].(map[string]interface{})
		if !ok {
			panic(fmt.Errorf("DoNothingPolicyItem schema not found"))
		}
	...
	rawOpenAPISpec = nil
	DoNothingPolicyResourceTypeDescriptor.Validator = validator
	DoNothingPolicyResourceTypeDescriptor.StructuralSchema = structuralSchema
}
