...
const file_api_mesh_v1alpha1_zoneegressoverview_proto_rawDesc = "" +
	"\n" +
	"*api/mesh/v1alpha1/zoneegressoverview.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a\"api/mesh/v1alpha1/zoneegress.proto\x1a)api/mesh/v1alpha1/zoneegressinsight.proto\"\xf0\x01\n" +
	"\x12ZoneEgressOverview\x12>\n" +
	"\n" +
	"zoneEgress\x18\x01 \x01(\v2\x1e.kuma.mesh.v1alpha1.ZoneEgressR\n" +
	"zoneEgress\x12S\n" +
	"\x11zoneEgressInsight\x18\x02 \x01(\v2%.kuma.mesh.v1alpha1.ZoneEgressInsightR\x11zoneEgressInsight:E\xaa\x8c\x89\xa6\x01?\n" +
	"\x1aZoneEgressOverviewResource\x12\x12ZoneEgressOverview\x18\x01\"\x04mesh0\x01`\x01\xa8\x01\x01B-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
