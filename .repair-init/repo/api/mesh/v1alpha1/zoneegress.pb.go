...
const file_api_mesh_v1alpha1_zoneegress_proto_rawDesc = "" +
	"\n" +
	"\"api/mesh/v1alpha1/zoneegress.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a#api/mesh/v1alpha1/envoy_admin.proto\"\x9b\x03\n" +
	"\n" +
	"ZoneEgress\x12\x12\n" +
	...
	"\x05admin\x18\x03 \x01(\v2\x1e.kuma.mesh.v1alpha1.EnvoyAdminR\x05admin:\xbb\x01\xaa\x8c\x89\xa6\x01\xb4\x01\n" +
	"\x12ZoneEgressResource\x12\n" +
	"ZoneEgress\x18\x01\"\x04mesh:\x1a\n" +
	"\n" +
	"zoneegress\x12\fzoneegressesR\x16model.ZoneToGlobalFlagX\x01\x8a\x01Edescription=\"Zone name\",JSONPath=`.spec.zone`,name=\"zone\",type=string\x90\x01\x01\x9a\x01\x02ze\xa0\x01\x01\xa8\x01\x01B-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
