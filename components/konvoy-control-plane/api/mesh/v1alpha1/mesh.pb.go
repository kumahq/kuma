...
type CertificateAuthority struct {
	...
	//	*CertificateAuthority_Embedded_
...
type CertificateAuthority_Embedded_ struct {
	Embedded *CertificateAuthority_Embedded `protobuf:"bytes,1,opt,name=embedded,proto3,oneof"`
}

func (*CertificateAuthority_Embedded_) isCertificateAuthority_Type() {}
...
func (m *CertificateAuthority) GetEmbedded() *CertificateAuthority_Embedded {
	if x, ok := m.GetType().(*CertificateAuthority_Embedded_); ok {
		return x.Embedded
	}
	return nil
}
...
func (*CertificateAuthority) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _CertificateAuthority_OneofMarshaler, _CertificateAuthority_OneofUnmarshaler, _CertificateAuthority_OneofSizer, []interface{}{
		(*CertificateAuthority_Embedded_)(nil),
	}
}
...
func _CertificateAuthority_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *CertificateAuthority_Embedded_:
		...
		if err := b.EncodeMessage(x.Embedded); err != nil {
			return err
		}
	case nil:
	default:
...
func _CertificateAuthority_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*CertificateAuthority)
	switch tag {
	case 1: // type.embedded
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CertificateAuthority_Embedded)
		err := b.DecodeMessage(msg)
		m.Type = &CertificateAuthority_Embedded_{msg}
		return true, err
	default:
		return false, nil
	}
...
// Embedded defines configuration of the embedded CA.
type CertificateAuthority_Embedded struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CertificateAuthority_Embedded) Reset()         { *m = CertificateAuthority_Embedded{} }
func (m *CertificateAuthority_Embedded) String() string { return proto.CompactTextString(m) }
func (*CertificateAuthority_Embedded) ProtoMessage()    {}
func (*CertificateAuthority_Embedded) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae9b3cd8c92bbf6a, []int{1, 0}
}
func (m *CertificateAuthority_Embedded) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CertificateAuthority_Embedded) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CertificateAuthority_Embedded.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *CertificateAuthority_Embedded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CertificateAuthority_Embedded.Merge(m, src)
}
func (m *CertificateAuthority_Embedded) XXX_Size() int {
	return m.Size()
}
func (m *CertificateAuthority_Embedded) XXX_DiscardUnknown() {
	xxx_messageInfo_CertificateAuthority_Embedded.DiscardUnknown(m)
}

var xxx_messageInfo_CertificateAuthority_Embedded proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CertificateAuthority_Embedded)(nil), "konvoy.mesh.v1alpha1.CertificateAuthority.Embedded")
...
var fileDescriptor_ae9b3cd8c92bbf6a = []byte{
	...
	,
}
...
func (m *CertificateAuthority_Embedded_) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Embedded != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintMesh(dAtA, i, uint64(m.Embedded.Size()))
		n5, err := m.Embedded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *CertificateAuthority_Embedded) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CertificateAuthority_Embedded) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CertificateAuthority_Embedded_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CertificateAuthority_Embedded) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CertificateAuthority) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			v := &CertificateAuthority_Embedded{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Type = &CertificateAuthority_Embedded_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMesh(dAtA[iNdEx:])
...
func (m *CertificateAuthority_Embedded) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
