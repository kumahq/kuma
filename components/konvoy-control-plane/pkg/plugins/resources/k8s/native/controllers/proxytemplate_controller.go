...
// +kubebuilder:rbac:groups=mesh.getkonvoy.io,resources=proxytemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mesh.getkonvoy.io,resources=proxytemplates/status,verbs=get;update;patch
