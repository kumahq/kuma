...
const (
	InterCpPingService_Ping_FullMethodName = "/kuma.system.v1alpha1.InterCpPingService/Ping"
)
...
func RegisterInterCpPingServiceServer(s grpc.ServiceRegistrar, srv InterCpPingServiceServer) {
	// If the following call panics, it indicates UnimplementedInterCpPingServiceServer was
