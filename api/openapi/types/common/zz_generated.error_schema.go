...
// Valid indicates whether the value is a known member of the InvalidParametersSource enum.
func (e InvalidParametersSource) Valid() bool {
	switch e {
	case Body:
		return true
	case Header:
...
// Valid indicates whether the value is a known member of the NotFoundErrorStatus enum.
func (e NotFoundErrorStatus) Valid() bool {
	switch e {
	case N404:
		return true
	default:
...
type NotFoundError struct {
	// Detail Example: The requested resource was not found
	Detail string `json:"detail"`
	...
	// Type Example: https://httpstatuses.com/404
	Type string `json:"type"`
}
