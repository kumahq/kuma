...
type KumaResourceOptions struct {
	...
	PolicyMatchingExempt bool `protobuf:"varint,21,opt,name=policy_matching_exempt,json=policyMatchingExempt,proto3" json:"policy_matching_exempt,omitempty"`
...
func (x *KumaResourceOptions) GetPolicyMatchingExempt() bool {
	if x != nil {
		return x.PolicyMatchingExempt
	}
	return false
}
...
const file_api_mesh_options_proto_rawDesc = "" +
	...
	"\x06policy\x12\x1f.google.protobuf.MessageOptions\x18Ƒ\xe1\x14 \x01(\v2\x1c.kuma.mesh.KumaPolicyOptionsR\x06policyB$Z\"github.com/kumahq/kuma/v3/api/meshb\x06proto3"
