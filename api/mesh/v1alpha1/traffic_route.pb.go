...
const file_api_mesh_v1alpha1_traffic_route_proto_rawDesc = "" +
	"\n" +
	"%api/mesh/v1alpha1/traffic_route.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a api/mesh/v1alpha1/selector.proto\x1a\x17validate/validate.proto\"\xdc\x1a\n" +
	"\fTrafficRoute\x12@\n" +
