...
const file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDesc = "" +
	"\n" +
	",api/mesh/v1alpha1/zone_ingress_insight.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a)api/mesh/v1alpha1/dataplane_insight.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x91\x02\n" +
	"\x12ZoneIngressInsight\x12O\n" +
	"\rsubscriptions\x18\x01 \x03(\v2).kuma.mesh.v1alpha1.DiscoverySubscriptionR\rsubscriptions\x123\n" +
	"\bmetadata\x18\x02 \x01(\v2\x17.google.protobuf.StructR\bmetadata:u\xaa\x8c\x89\xa6\x01o\n" +
	"\x1aZoneIngressInsightResource\x12\x12ZoneIngressInsight\x18\x01\"\x04mesh:\x18\n" +
	"\x14zone-ingress-insight\x18\x01R\x16model.ZoneToGlobalFlagX\x01\xa8\x01\x01B-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"

var (
	file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDescOnce sync.Once
	file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDescData []byte
)
...
func file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDescGZIP() []byte {
	file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDescOnce.Do(func() {
		file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDesc), len(file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDesc)))
	})
...
var file_api_mesh_v1alpha1_zone_ingress_insight_proto_goTypes = []any{
...
func file_api_mesh_v1alpha1_zone_ingress_insight_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDesc), len(file_api_mesh_v1alpha1_zone_ingress_insight_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
