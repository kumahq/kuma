...
func (x *Message) GetRequestV3() *v3.DiscoveryRequest {
	if x, ok := x.GetValue().(*Message_RequestV3); ok {
		return x.RequestV3
	}
	return nil
}

func (x *Message) GetResponseV3() *v3.DiscoveryResponse {
	if x, ok := x.GetValue().(*Message_ResponseV3); ok {
		return x.ResponseV3
	}
	return nil
}
...
type Message_RequestV3 struct {
	RequestV3 *v3.DiscoveryRequest `protobuf:"bytes,3,opt,name=requestV3,proto3,oneof"`
}

type Message_ResponseV3 struct {
	ResponseV3 *v3.DiscoveryResponse `protobuf:"bytes,4,opt,name=responseV3,proto3,oneof"`
}
...
func (*Message_RequestV3) isMessage_Value() {}

func (*Message_ResponseV3) isMessage_Value() {}
...
var file_mesh_v1alpha1_mux_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x02, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	...
	0x73, 0x65, 0x48, 0x00, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c,
	0x0a, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x56, 0x33, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	,
...
var file_mesh_v1alpha1_mux_proto_depIdxs = []int32{
	1, // 0: kuma.mesh.v1alpha1.Message.request:type_name -> envoy.api.v2.DiscoveryRequest
	2, // 1: kuma.mesh.v1alpha1.Message.response:type_name -> envoy.api.v2.DiscoveryResponse
	3, // 2: kuma.mesh.v1alpha1.Message.requestV3:type_name -> envoy.service.discovery.v3.DiscoveryRequest
	4, // 3: kuma.mesh.v1alpha1.Message.responseV3:type_name -> envoy.service.discovery.v3.DiscoveryResponse
...
func file_mesh_v1alpha1_mux_proto_init() {
	...
	file_mesh_v1alpha1_mux_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Message_RequestV3)(nil),
		(*Message_ResponseV3)(nil),
	}
	type x struct{}
