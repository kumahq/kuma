...
type PrometheusMetricsBackendConfig struct {
	...
	// Configuration of TLS for Prometheus endpoint
...
func (x *PrometheusMetricsBackendConfig) GetTls() *TlsConfig {
	if x != nil {
		return x.Tls
	}
	return nil
...
// TlsConfig defines configuration of TLS
type TlsConfig struct {
	...
	// Defines a path to a file with PEM-encoded Root CA. Client will verify server by using it.
	RootCaFile string `protobuf:"bytes,2,opt,name=rootCaFile,proto3" json:"rootCaFile,omitempty"`
	// Defines a path to a file with PEM-encoded TLS cert
	CertFile string `protobuf:"bytes,3,opt,name=certFile,proto3" json:"certFile,omitempty"`
	// Defines a path to a file with PEM-encoded TLS key
	KeyFile string `protobuf:"bytes,4,opt,name=keyFile,proto3" json:"keyFile,omitempty"`
	// The minimum version of TLS
	MinVersion string `protobuf:"bytes,5,opt,name=minVersion,proto3" json:"minVersion,omitempty"`
	// The maximum version of TLS
	MaxVersion string `protobuf:"bytes,6,opt,name=maxVersion,proto3" json:"maxVersion,omitempty"`
...
func (x *TlsConfig) GetEnabled() *wrapperspb.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *TlsConfig) GetRootCaFile() string {
	if x != nil {
		return x.RootCaFile
	}
	return ""
...
func (x *PrometheusEnvoyConfig) Reset() {
	*x = PrometheusEnvoyConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mesh_v1alpha1_metrics_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PrometheusEnvoyConfig) Descriptor() ([]byte, []int) {
	return file_mesh_v1alpha1_metrics_proto_rawDescGZIP(), []int{5}
}
...
var file_mesh_v1alpha1_metrics_proto_rawDesc = []byte{
	...
	0x75, 0x63, 0x74, 0x52, 0x04, 0x63, 0x6f, 0x6e, 0x66, 0x22, 0xd1, 0x03, 0x0a, 0x1e, 0x50, 0x72,
	...
	,
	...
	,
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x08, 0x75, 0x73, 0x65, 0x64, 0x4f, 0x6e, 0x6c, 0x79, 0x42,
...
var file_mesh_v1alpha1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_mesh_v1alpha1_metrics_proto_goTypes = []interface{}{
	...
	(*TlsConfig)(nil),                        // 3: kuma.mesh.v1alpha1.TlsConfig
	...
	nil,                                      // 6: kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.TagsEntry
...
var file_mesh_v1alpha1_metrics_proto_depIdxs = []int32{
	...
	7,  // 1: kuma.mesh.v1alpha1.MetricsBackend.conf:type_name -> google.protobuf.Struct
	6,  // 2: kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.tags:type_name -> kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.TagsEntry
	8,  // 3: kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.skipMTLS:type_name -> google.protobuf.BoolValue
	...
	3,  // 6: kuma.mesh.v1alpha1.PrometheusMetricsBackendConfig.tls:type_name -> kuma.mesh.v1alpha1.TlsConfig
	8,  // 7: kuma.mesh.v1alpha1.TlsConfig.enabled:type_name -> google.protobuf.BoolValue
	8,  // 8: kuma.mesh.v1alpha1.PrometheusAggregateMetricsConfig.enabled:type_name -> google.protobuf.BoolValue
	8,  // 9: kuma.mesh.v1alpha1.PrometheusEnvoyConfig.usedOnly:type_name -> google.protobuf.BoolValue
...
func file_mesh_v1alpha1_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mesh_v1alpha1_metrics_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
