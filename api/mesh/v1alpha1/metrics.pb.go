...
const (
	// This is a substitute of `skipMTLS` set to false. In this situation,
...
type PrometheusTlsConfig struct {
	...
	// If true then endpoints for scraping metrics will require TLS, when false
	// there if no tls configured. If nil, then it is treated as true.
	Enabled *wrapperspb.BoolValue `protobuf:"bytes,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// mode defines how configured is the TLS for Prometheus.
	// Supported values, delegated, activeMTLSBackend. Default to `activeMTLSBackend`.
...
var file_api_mesh_v1alpha1_metrics_proto_rawDesc = []byte{
	...
	0x2c, 0x0a, 0x04, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x4d, 0x54, 0x4c, 0x53, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x10, 0x00, 0x12, 0x0d,
	0x0a, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x65, 0x64, 0x10, 0x01, 0x42, 0x2a, 0x5a,
