...
const (
	...
	// * KUMA_DPP_METRICS_TLS_CERT_FILE
	// * KUMA_DPP_METRICS_TLS_KEY_FILE
	PrometheusTlsConfig_delegated PrometheusTlsConfig_Mode = 0
	// This is a substitute of `skipMTLS` set to false. In this situation, control-plane
	// delivers certificates to the prometheus listener.
	PrometheusTlsConfig_activeMTLSBackend PrometheusTlsConfig_Mode = 1
)
...
type PrometheusTlsConfig struct {
	...
	// If true then endpoints for scraping metrics will require TLS, when false there
	// if no tls configured. If nil, then it is treated as true.
	Enabled *wrapperspb.BoolValue `protobuf:"bytes,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// mode defines how configured is the TLS for Prometheus.
	// Supported values, delegated, activeMTLSBackend
	Mode PrometheusTlsConfig_Mode `protobuf:"varint,2,opt,name=mode,proto3,enum=kuma.mesh.v1alpha1.PrometheusTlsConfig_Mode" json:"mode,omitempty"`
}
...
func (x *PrometheusTlsConfig) GetEnabled() *wrapperspb.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *PrometheusTlsConfig) GetMode() PrometheusTlsConfig_Mode {
	...
	return PrometheusTlsConfig_delegated
}
...
var file_api_mesh_v1alpha1_metrics_proto_rawDesc = []byte{
	...
	0xbb, 0x01, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x54, 0x6c,
	...
	,
...
var file_api_mesh_v1alpha1_metrics_proto_depIdxs = []int32{
	...
	9,  // 9: kuma.mesh.v1alpha1.PrometheusTlsConfig.enabled:type_name -> google.protobuf.BoolValue
	0,  // 10: kuma.mesh.v1alpha1.PrometheusTlsConfig.mode:type_name -> kuma.mesh.v1alpha1.PrometheusTlsConfig.Mode
