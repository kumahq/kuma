...
func (*Dataplane_Networking_TransparentProxying_ReachableBackends) Descriptor() ([]byte, []int) {
	return file_api_mesh_v1alpha1_dataplane_proto_rawDescGZIP(), []int{0, 0, 2, 1}
}
...
const file_api_mesh_v1alpha1_dataplane_proto_rawDesc = "" +
	"\n" +
	"!api/mesh/v1alpha1/dataplane.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a#api/mesh/v1alpha1/envoy_admin.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xb7\x18\n" +
	"\tDataplane\x12H\n" +
	"\n" +
	"networking\x18\x01 \x01(\v2(.kuma.mesh.v1alpha1.Dataplane.NetworkingR\n" +
	"networking\x1a\xe1\x16\n" +
	"\n" +
	"Networking\x12\x18\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x05\x10\x06R\x04tags\x1a\xb3\x06\n" +
	...
	"\x12reachable_backends\x18\a \x01(\v2N.kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackendsR\x11reachableBackends\x1a\xa9\x02\n" +
	...
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\x04nameR\tnamespace\x1ay\n" +
	...
	"\x05State\x12\t\n" +
	"\x05Ready\x10\x00\x12\f\n" +
	"\bNotReady\x10\x01J\x04\b\x06\x10\aJ\x04\b\a\x10\bJ\x04\b\x03\x10\x04R\agateway:_\xaa\x8c\x89\xa6\x01Y\n" +
