...
const file_api_mesh_v1alpha1_dataplane_proto_rawDesc = "" +
	"\n" +
	"!api/mesh/v1alpha1/dataplane.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a#api/mesh/v1alpha1/envoy_admin.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\"\xc5#\n" +
	"\tDataplane\x12H\n" +
	"\n" +
	"networking\x18\x01 \x01(\v2(.kuma.mesh.v1alpha1.Dataplane.NetworkingR\n" +
	"networking\x1a\x81\x1d\n" +
	"\n" +
	"Networking\x12\x18\n" +
	...
	"\x05State\x12\t\n" +
	"\x05Ready\x10\x00\x12\f\n" +
	"\bNotReady\x10\x01J\x04\b\x06\x10\aJ\x04\b\a\x10\b:\xcc\x05\xaa\x8c\x89\xa6\x01\xc5\x05\n" +
	"\x11DataplaneResource\x12\tDataplane\"\x04mesh:\v\n" +
	"\tdataplaneR\x16model.ZoneToGlobalFlagX\x01\x8a\x01\x91\x01description=\"Service tag of the first inbound\",JSONPath=`.spec.networking.inbound[0].tags['kuma\\.io/service']`,name=\"kuma.io/service\",type=string\x8a\x01\x92\x01description=\"Service tag of the second inbound\",JSONPath=`.spec.networking.inbound[1].tags['kuma\\.io/service']`,name=\"kuma.io/service\",type=string\x8a\x01\x9c\x01description=\"Service tag of the third inbound\",JSONPath=`.spec.networking.inbound[2].tags['kuma\\.io/service']`,name=\"kuma.io/service\",type=string,priority=1\x8a\x01\x9d\x01description=\"Service tag of the fourth inbound\",JSONPath=`.spec.networking.inbound[3].tags['kuma\\.io/service']`,name=\"kuma.io/service\",type=string,priority=1\x90\x01\x01\x9a\x01\x02dp\xa0\x01\x01\xa8\x01\x01J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\ametricsR\x06probesB-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
...
var file_api_mesh_v1alpha1_dataplane_proto_goTypes = []any{
	...
	nil,                                                        // 12: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.TagsEntry
	(*Dataplane_Networking_Inbound_Health)(nil),                // 13: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.Health
	(*Dataplane_Networking_Inbound_ServiceProbe)(nil),          // 14: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.ServiceProbe
	(*Dataplane_Networking_Inbound_ServiceProbe_Tcp)(nil),      // 15: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.ServiceProbe.Tcp
	nil, // 16: kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.TagsEntry
...
var file_api_mesh_v1alpha1_dataplane_proto_depIdxs = []int32{
	...
	23, // 5: kuma.mesh.v1alpha1.Dataplane.Networking.admin:type_name -> kuma.mesh.v1alpha1.EnvoyAdmin
	11, // 6: kuma.mesh.v1alpha1.Dataplane.Networking.listeners:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Listener
	12, // 7: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.tags:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.TagsEntry
	13, // 8: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.health:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.Health
	14, // 9: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.serviceProbe:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.ServiceProbe
	...
	16, // 11: kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.tags:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.TagsEntry
	17, // 12: kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.backendRef:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.BackendRef
	19, // 13: kuma.mesh.v1alpha1.Dataplane.Networking.Gateway.tags:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Gateway.TagsEntry
	...
	21, // 16: kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.reachable_backends:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackends
	3,  // 17: kuma.mesh.v1alpha1.Dataplane.Networking.Listener.type:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Listener.Type
	4,  // 18: kuma.mesh.v1alpha1.Dataplane.Networking.Listener.state:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Listener.State
	...
	15, // 23: kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.ServiceProbe.tcp:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Inbound.ServiceProbe.Tcp
	18, // 24: kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.BackendRef.labels:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.Outbound.BackendRef.LabelsEntry
	...
	22, // 26: kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackendRef.labels:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackendRef.LabelsEntry
	20, // 27: kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackends.refs:type_name -> kuma.mesh.v1alpha1.Dataplane.Networking.TransparentProxying.ReachableBackendRef
