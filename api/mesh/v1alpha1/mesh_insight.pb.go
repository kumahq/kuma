...
const file_api_mesh_v1alpha1_mesh_insight_proto_rawDesc = "" +
	"\n" +
	"$api/mesh/v1alpha1/mesh_insight.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\"\xc9\x0f\n" +
	"\vMeshInsight\x12M\n" +
	"\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12C\n" +
	"\x05value\x18\x02 \x01(\v2-.kuma.mesh.v1alpha1.MeshInsight.DataplaneStatR\x05value:\x028\x01\x1a\xd8\x02\n" +
...
var file_api_mesh_v1alpha1_mesh_insight_proto_depIdxs = []int32{
	...
	1,  // 11: kuma.mesh.v1alpha1.MeshInsight.DataplanesByType.gatewayBuiltin:type_name -> kuma.mesh.v1alpha1.MeshInsight.DataplaneStat
	1,  // 12: kuma.mesh.v1alpha1.MeshInsight.DataplanesByType.gatewayDelegated:type_name -> kuma.mesh.v1alpha1.MeshInsight.DataplaneStat
	5,  // 13: kuma.mesh.v1alpha1.MeshInsight.ResourcesEntry.value:type_name -> kuma.mesh.v1alpha1.MeshInsight.ResourceStat
