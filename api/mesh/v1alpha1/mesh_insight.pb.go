...
type MeshInsight struct {
	...
	// Connected Dataplanes grouped by mTLS backends
	MTLSBackends map[string]*MeshInsight_DataplaneStat `protobuf:"bytes,5,rep,name=mTLSBackends,proto3" json:"mTLSBackends,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *MeshInsight) GetMTLSBackends() map[string]*MeshInsight_DataplaneStat {
	if x != nil {
		return x.MTLSBackends
	}
	return nil
}
...
var file_mesh_v1alpha1_mesh_insight_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4, 0x09, 0x0a, 0x0b,
	...
	0x64, 0x70, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x55, 0x0a, 0x0c, 0x6d, 0x54,
	0x4c, 0x53, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	...
	0x74, 0x2e, 0x4d, 0x54, 0x4c, 0x53, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x52, 0x0c, 0x6d, 0x54, 0x4c, 0x53, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64,
	0x73, 0x1a, 0x86, 0x01, 0x0a, 0x0d, 0x44, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x53,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x6e, 0x0a, 0x11, 0x4d, 0x54, 0x4c, 0x53, 0x42, 0x61,
...
var file_mesh_v1alpha1_mesh_insight_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_mesh_v1alpha1_mesh_insight_proto_goTypes = []interface{}{
	...
	nil,                               // 5: kuma.mesh.v1alpha1.MeshInsight.MTLSBackendsEntry
...
var file_mesh_v1alpha1_mesh_insight_proto_depIdxs = []int32{
	8,  // 0: kuma.mesh.v1alpha1.MeshInsight.last_sync:type_name -> google.protobuf.Timestamp
	...
	5,  // 4: kuma.mesh.v1alpha1.MeshInsight.mTLSBackends:type_name -> kuma.mesh.v1alpha1.MeshInsight.MTLSBackendsEntry
	...
	1,  // 8: kuma.mesh.v1alpha1.MeshInsight.MTLSBackendsEntry.value:type_name -> kuma.mesh.v1alpha1.MeshInsight.DataplaneStat
