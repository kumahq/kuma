...
const file_api_mesh_v1alpha1_dataplane_insight_proto_rawDesc = "" +
	"\n" +
	")api/mesh/v1alpha1/dataplane_insight.proto\x12\x12kuma.mesh.v1alpha1\x1a\x16api/mesh/options.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\xef\n" +
	"\n" +
	...
	"\x0eblockedReasons\x18\a \x03(\tR\x0eblockedReasons:l\xaa\x8c\x89\xa6\x01f\n" +
	"\x18DataplaneInsightResource\x12\x10DataplaneInsight\"\x04mesh:\x15\n" +
	"\x11dataplane-insight\x18\x01R\x16model.ZoneToGlobalFlagX\x01\xa8\x01\x01\"\xac\x03\n" +
	...
	"\x10kumaDpCompatible\x18\x03 \x01(\bR\x10kumaDpCompatibleB-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
