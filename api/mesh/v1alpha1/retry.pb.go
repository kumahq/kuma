...
type Retry_Conf struct {
	...
	//	*Retry_Conf_Tcp_
	//	*Retry_Conf_Grpc_
	Protocol isRetry_Conf_Protocol `protobuf_oneof:"protocol"`
}
...
func (m *Retry_Conf) GetProtocol() isRetry_Conf_Protocol {
	if m != nil {
		return m.Protocol
	}
	return nil
...
func (x *Retry_Conf) GetHttp() *Retry_Conf_Http {
	if x, ok := x.GetProtocol().(*Retry_Conf_Http_); ok {
		return x.Http
	}
	return nil
}
...
func (x *Retry_Conf) GetTcp() *Retry_Conf_Tcp {
	if x, ok := x.GetProtocol().(*Retry_Conf_Tcp_); ok {
		return x.Tcp
	}
	return nil
}
...
func (x *Retry_Conf) GetGrpc() *Retry_Conf_Grpc {
	if x, ok := x.GetProtocol().(*Retry_Conf_Grpc_); ok {
		return x.Grpc
	}
	return nil
}

type isRetry_Conf_Protocol interface {
	isRetry_Conf_Protocol()
}

type Retry_Conf_Http_ struct {
	Http *Retry_Conf_Http `protobuf:"bytes,1,opt,name=http,proto3,oneof"`
}

type Retry_Conf_Tcp_ struct {
	Tcp *Retry_Conf_Tcp `protobuf:"bytes,2,opt,name=tcp,proto3,oneof"`
}

type Retry_Conf_Grpc_ struct {
	Grpc *Retry_Conf_Grpc `protobuf:"bytes,3,opt,name=grpc,proto3,oneof"`
}

func (*Retry_Conf_Http_) isRetry_Conf_Protocol() {}

func (*Retry_Conf_Tcp_) isRetry_Conf_Protocol() {}

func (*Retry_Conf_Grpc_) isRetry_Conf_Protocol() {}
...
var file_mesh_v1alpha1_retry_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd1, 0x09, 0x0a, 0x05, 0x52, 0x65, 0x74, 0x72, 0x79,
	...
	0x6e, 0x66, 0x1a, 0x85, 0x08, 0x0a, 0x04, 0x43, 0x6f, 0x6e, 0x66, 0x12, 0x39, 0x0a, 0x04, 0x68,
	...
	0x65, 0x74, 0x72, 0x79, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x48, 0x00,
	...
	0x6f, 0x6e, 0x66, 0x2e, 0x54, 0x63, 0x70, 0x48, 0x00, 0x52, 0x03, 0x74, 0x63, 0x70, 0x12, 0x39,
	...
	0x63, 0x48, 0x00, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x1a, 0x87, 0x01, 0x0a, 0x07, 0x42, 0x61,
	0x63, 0x6b, 0x4f, 0x66, 0x66, 0x12, 0x3e, 0x0a, 0x0d, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x62, 0x61, 0x73, 0x65, 0x49, 0x6e, 0x74,
	...
	0x76, 0x61, 0x6c, 0x1a, 0x81, 0x02, 0x0a, 0x04, 0x48, 0x74, 0x74, 0x70, 0x12, 0x3d, 0x0a, 0x0b,
	...
	,
	...
	0x6f, 0x75, 0x74, 0x12, 0x41, 0x0a, 0x08, 0x62, 0x61, 0x63, 0x6b, 0x5f, 0x6f, 0x66, 0x66, 0x18,
	...
	,
...
func file_mesh_v1alpha1_retry_proto_init() {
	...
	file_mesh_v1alpha1_retry_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Retry_Conf_Http_)(nil),
		(*Retry_Conf_Tcp_)(nil),
		(*Retry_Conf_Grpc_)(nil),
	}
	type x struct{}
