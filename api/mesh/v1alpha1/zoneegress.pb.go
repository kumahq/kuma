...
const file_api_mesh_v1alpha1_zoneegress_proto_rawDesc = "" +
	...
	"\n" +
	"zoneegress\x12\fzoneegressesR\x16model.ZoneToGlobalFlagX\x01\x8a\x01Edescription=\"Zone name\",JSONPath=`.spec.zone`,name=\"zone\",type=string\x90\x01\x01\x9a\x01\x02ze\xa0\x01\x01B-Z+github.com/kumahq/kuma/v3/api/mesh/v1alpha1b\x06proto3"
