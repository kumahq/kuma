...
type ZoneIngress struct {
	...
	// endpoints
	AvailableServices []*ZoneIngress_AvailableService `protobuf:"bytes,5,rep,name=availableServices,proto3" json:"availableServices,omitempty"`
}
...
func (x *ZoneIngress) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *ZoneIngress) GetAdvertisedAddress() string {
	if x != nil {
...
func (x *ZoneIngress) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *ZoneIngress) GetAdvertisedPort() uint32 {
	if x != nil {
...
var file_mesh_v1alpha1_zone_ingress_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x03, 0x0a,
	0x0b, 0x5a, 0x6f, 0x6e, 0x65, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x18, 0x0a, 0x07,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2c, 0x0a, 0x11, 0x61, 0x64, 0x76, 0x65, 0x72, 0x74,
	0x69, 0x73, 0x65, 0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x26, 0x0a, 0x0e, 0x61, 0x64, 0x76, 0x65,
	0x72, 0x74, 0x69, 0x73, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0e, 0x61, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69, 0x73, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74,
	0x12, 0x12, 0x0a, 0x04, 0x7a, 0x6f, 0x6e, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x7a, 0x6f, 0x6e, 0x65, 0x12, 0x5e, 0x0a, 0x11, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c,
	0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x69, 0x63, 0x65, 0x73, 0x1a, 0xcd, 0x01, 0x0a, 0x10, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62,
...
var file_mesh_v1alpha1_zone_ingress_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mesh_v1alpha1_zone_ingress_proto_goTypes = []interface{}{
	(*ZoneIngress)(nil),                  // 0: kuma.mesh.v1alpha1.ZoneIngress
	(*ZoneIngress_AvailableService)(nil), // 1: kuma.mesh.v1alpha1.ZoneIngress.AvailableService
	nil,                                  // 2: kuma.mesh.v1alpha1.ZoneIngress.AvailableService.TagsEntry
}
var file_mesh_v1alpha1_zone_ingress_proto_depIdxs = []int32{
	1, // 0: kuma.mesh.v1alpha1.ZoneIngress.availableServices:type_name -> kuma.mesh.v1alpha1.ZoneIngress.AvailableService
	2, // 1: kuma.mesh.v1alpha1.ZoneIngress.AvailableService.tags:type_name -> kuma.mesh.v1alpha1.ZoneIngress.AvailableService.TagsEntry
